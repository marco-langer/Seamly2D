...
void TST_VSplinePath::TestRotation_data()
{
    ...
    {
        VPointF pSpline(
            198.77104389529981, 249.18158602595835, "X", 5.0000125984251973, 9.9999874015748045);
        VSplinePoint p(
            pSpline,
            146.43199999999999,
            "146.432",
    ...
    {
        VPointF pSpline(
            820.42771653543309, 417.95262992125987, "X", 5.0000125984251973, 9.9999874015748045);
        VSplinePoint p(
            pSpline,
            173.39500000000001,
            "173.395",
    ...
    {
        VPointF pSpline(
            -347.55140568256883, 400.53936590535034, "X", 5.0000125984251973, 9.9999874015748045);
        VSplinePoint p(
            pSpline,
            176.56789999999998,
            "176.568",
    ...
    {
        VPointF pSpline(
            -130.81610509751462, 241.58508512833563, "X", 5.0000125984251973, 9.9999874015748045);
        VSplinePoint p(
            pSpline,
            233.79130000000001,
            "233.791",
    ...
    {
        VPointF pSpline(
            66.417055567032421, -371.63572683892357, "X", 5.0000125984251973, 9.9999874015748045);
        VSplinePoint p(
            pSpline,
            260.7543,
            "260.754",
    ...
    QTest::newRow("Test spline path 1") << originPoints << QPointF(30, 417.95262992125987)
                                        << 87.359300000000005 << "a2" << rotatedPoints;
}
