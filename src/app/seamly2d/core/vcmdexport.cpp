...
void VCommandLine::initOptions(VCommandLineOptions& options, QMap<QString, int>& optionsIndex)
{
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_BASENAME << LONG_OPTION_BASENAME,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_DESTINATION << LONG_OPTION_DESTINATION,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_MEASUREFILE << LONG_OPTION_MEASUREFILE,
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_EXP2FORMAT << LONG_OPTION_EXP2FORMAT,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_GRADATIONSIZE << LONG_OPTION_GRADATIONSIZE,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_GRADATIONHEIGHT << LONG_OPTION_GRADATIONHEIGHT,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_PAGETEMPLATE << LONG_OPTION_PAGETEMPLATE,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_PAGEW << LONG_OPTION_PAGEW,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_PAGEH << LONG_OPTION_PAGEH,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_PAGEUNITS << LONG_OPTION_PAGEUNITS,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_IGNORE_MARGINS << LONG_OPTION_IGNORE_MARGINS,
        translate(
            "VCommandLine",
            "Ignore margins printing (export mode). Disable value keys: "
            "\"%1\", \"%2\", \"%3\", \"%4\". Set all margins to 0.")
            .arg(LONG_OPTION_LEFT_MARGIN)
            .arg(LONG_OPTION_RIGHT_MARGIN)
            .arg(LONG_OPTION_TOP_MARGIN)
            .arg(LONG_OPTION_BOTTOM_MARGIN)));

    optionsIndex.insert(LONG_OPTION_LEFT_MARGIN, index++);
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_LEFT_MARGIN << LONG_OPTION_LEFT_MARGIN,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_RIGHT_MARGIN << LONG_OPTION_RIGHT_MARGIN,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_TOP_MARGIN << LONG_OPTION_TOP_MARGIN,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_BOTTOM_MARGIN << LONG_OPTION_BOTTOM_MARGIN,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_ROTATE << LONG_OPTION_ROTATE,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_SAVELENGTH << LONG_OPTION_SAVELENGTH,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_SHIFTUNITS << LONG_OPTION_SHIFTUNITS,
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_SHIFTLENGTH << LONG_OPTION_SHIFTLENGTH,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_GAPWIDTH << LONG_OPTION_GAPWIDTH,
        translate(
            "VCommandLine",
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_GROUPPING << LONG_OPTION_GROUPPING,
    ...
    options.append(new QCommandLineOption(
        QStringList() << SINGLE_OPTION_TEST << LONG_OPTION_TEST,
        translate(
            "VCommandLine",
...
{
    // this functions covers all options found into layout setup dialog, nothing to add here, unless
    // dialog extended
...

    {
        ...
        if ((a || b || c) && x) {
            qCritical() << translate(
                "VCommandLine", "Cannot use pageformat and page explicit size/units together.")
                        << "\n";
        ...
        if ((a || b || c) && !(a && b && c)) {
            qCritical() << translate(
                "VCommandLine", "Page height, width, units must be used all 3 at once.")
                        << "\n";
            const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
        }
    }

    {
        ...
        if ((a || b) && !(a && b)) {
            qCritical() << translate(
                "VCommandLine", "Shift/Offset length must be used together with shift units.")
                        << "\n";
            const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
        }
    }

    {
        ...
        if ((a || b) && !(a && b)) {
            qCritical() << translate(
                "VCommandLine", "Gap width must be used together with shift units.")
                        << "\n";
            const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
        }
    }

    {
        ...
        if ((a || b) && !(a && b)) {
            qCritical() << translate(
                "VCommandLine", "Left margin must be used together with page units.")
                        << "\n";
            const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
        }
    }

    {
        ...
        if ((a || b) && !(a && b)) {
            qCritical() << translate(
                "VCommandLine", "Right margin must be used together with page units.")
                        << "\n";
            const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
        }
    }

    {
        ...
        if ((a || b) && !(a && b)) {
            qCritical() << translate(
                "VCommandLine", "Top margin must be used together with page units.")
                        << "\n";
            const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
        }
    }

    {
        ...
        if ((a || b) && !(a && b)) {
            qCritical() << translate(
                "VCommandLine", "Bottom margin must be used together with page units.")
                        << "\n";
            const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
        }
    }
    ...
    if (rotateDegree != VSettings::GetDefLayoutRotationIncrease())   // Value by default
    {
        if (not diag.SetIncrease(rotateDegree)) {
            qCritical() << translate(
                "VCommandLine", "Invalid rotation value. That must be one of predefined values.")
                        << "\n";
            const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
        }
    }
    ...
    if (parser.isSet(*optionsUsed.value(optionsIndex.value(
            LONG_OPTION_PAGEH)))) {   // at this point we already sure 3 are set or none

        if (!diag.SelectPaperUnit(
                parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_PAGEUNITS))))) {
            qCritical() << translate("VCommandLine", "Unsupported paper units.") << "\n";
            const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
        }

        diag.SetPaperHeight(
            Pg2Px(parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_PAGEH))), diag));
        diag.SetPaperWidth(
            Pg2Px(parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_PAGEW))), diag));
    }

    if (parser.isSet(*optionsUsed.value(optionsIndex.value(LONG_OPTION_SHIFTUNITS)))) {
        if (!diag.SelectLayoutUnit(
                parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_SHIFTUNITS))))) {
    ...
    if (parser.isSet(*optionsUsed.value(optionsIndex.value(LONG_OPTION_SHIFTLENGTH)))) {
        diag.SetShift(Lo2Px(
            parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_SHIFTLENGTH))), diag));
    }

    if (parser.isSet(*optionsUsed.value(optionsIndex.value(LONG_OPTION_GAPWIDTH)))) {
        diag.SetLayoutWidth(Lo2Px(
            parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_GAPWIDTH))), diag));
    }
    ...
    diag.SetSaveLength(
        parser.isSet(*optionsUsed.value(optionsIndex.value(LONG_OPTION_SAVELENGTH))));
    ...
    if (parser.isSet(*optionsUsed.value(optionsIndex.value(LONG_OPTION_IGNORE_MARGINS)))) {
...

        {
            const QCommandLineOption* option =
                optionsUsed.value(optionsIndex.value(LONG_OPTION_LEFT_MARGIN));
        ...
        {
            const QCommandLineOption* option =
                optionsUsed.value(optionsIndex.value(LONG_OPTION_RIGHT_MARGIN));
            if (parser.isSet(*option)) {
        ...
        {
            const QCommandLineOption* option =
                optionsUsed.value(optionsIndex.value(LONG_OPTION_TOP_MARGIN));
            if (parser.isSet(*option)) {
        ...
        {
            const QCommandLineOption* option =
                optionsUsed.value(optionsIndex.value(LONG_OPTION_BOTTOM_MARGIN));
            if (parser.isSet(*option)) {
...
//------------------------------------------------------------------------------------------------------
void VCommandLine::Reset() { instance.reset(); }
...
bool VCommandLine::IsTestModeEnabled() const
{
    ...
    if (r && parser.positionalArguments().size() != 1) {
        qCritical() << translate(
            "VCommandLine", "Test option can be used with single input file only.")
                    << "/n";
        const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
    }
    return r;
...
bool VCommandLine::IsExportEnabled() const
{
    ...
    if (r && parser.positionalArguments().size() != 1) {
        qCritical() << translate(
            "VCommandLine", "Export options can be used with single input file only.")
                    << "/n";
        const_cast<VCommandLine*>(this)->parser.showHelp(V_EX_USAGE);
    }
    return r;
...
PaperSizeFormat VCommandLine::OptPaperSize() const
{
    ...
    if (parser.isSet(*optionsUsed.value(optionsIndex.value(LONG_OPTION_PAGETEMPLATE)))) {
        ppsize =
            parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_PAGETEMPLATE))).toInt();
    }
...
int VCommandLine::OptRotation() const
{
    ...
    if (parser.isSet(*optionsUsed.value(optionsIndex.value(LONG_OPTION_ROTATE)))) {
        bool ok = false;
        rotate =
            parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_ROTATE))).toInt(&ok);
...
//---------------------------------------------------------------------------------------------------------------------
QStringList VCommandLine::OptInputFileNames() const { return parser.positionalArguments(); }

//---------------------------------------------------------------------------------------------------------------------
bool VCommandLine::IsGuiEnabled() const { return isGuiEnabled; }
...
{
    const QString size =
        parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_GRADATIONSIZE)));
...
QString VCommandLine::OptGradationHeight() const
{
    const QString height =
        parser.value(*optionsUsed.value(optionsIndex.value(LONG_OPTION_GRADATIONHEIGHT)));
