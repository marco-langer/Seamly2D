...
//---------------------------------------------------------------------------------------------------------------------
VToolOptionsPropertyBrowser::VToolOptionsPropertyBrowser(
    const VContainer* data, QDockWidget* parent)
    : QObject(parent)
    , m_data(data)
    ...
    , m_centerPointStr(tr("Center point"))
{
    ...
    connect(
        propertyModel,
        &VPE::VPropertyModel::onDataChangedByEditor,
        this,
...
void VToolOptionsPropertyBrowser::showItemOptions(QGraphicsItem* item)
{
    ...
    static_assert(
        static_cast<int>(Tool::LAST_ONE_DO_NOT_USE) == 54, "Not all tools were used in switch.");

    switch (item->type()) {
    case VToolBasePoint::Type: showOptionsToolSinglePoint(item); break;
    case VToolEndLine::Type: showOptionsToolEndLine(item); break;
    case VToolAlongLine::Type: showOptionsToolAlongLine(item); break;
    case VToolArc::Type: showOptionsToolArc(item); break;
    case VToolArcWithLength::Type: showOptionsToolArcWithLength(item); break;
    case VToolBisector::Type: showOptionsToolBisector(item); break;
    case VToolCutArc::Type: showOptionsToolCutArc(item); break;
    case VToolCutSpline::Type: showOptionsToolCutSpline(item); break;
    case VToolCutSplinePath::Type: showOptionsToolCutSplinePath(item); break;
    case VToolHeight::Type: showOptionsToolHeight(item); break;
    case VToolLine::Type: showOptionsToolLine(item); break;
    case VToolLineIntersect::Type: showOptionsToolLineIntersect(item); break;
    case VToolNormal::Type: showOptionsToolNormal(item); break;
    case VToolPointOfContact::Type: showOptionsToolPointOfContact(item); break;
    case PointIntersectXYTool::Type: showOptionsToolPointOfIntersection(item); break;
    case VToolPointOfIntersectionArcs::Type: showOptionsToolPointOfIntersectionArcs(item); break;
    case IntersectCirclesTool::Type: showOptionsToolPointOfIntersectionCircles(item); break;
    case VToolPointOfIntersectionCurves::Type:
        showOptionsToolPointOfIntersectionCurves(item);
        break;
    case VToolShoulderPoint::Type: showOptionsToolShoulderPoint(item); break;
    case VToolSpline::Type: showOptionsToolSpline(item); break;
    case VToolCubicBezier::Type: showOptionsToolCubicBezier(item); break;
    case VToolSplinePath::Type: showOptionsToolSplinePath(item); break;
    case VToolCubicBezierPath::Type: showOptionsToolCubicBezierPath(item); break;
    case VToolTriangle::Type: showOptionsToolTriangle(item); break;
    ...
    case VSimpleCurve::Type:
        ...
        break;
    case VToolLineIntersectAxis::Type: showOptionsToolLineIntersectAxis(item); break;
    case VToolCurveIntersectAxis::Type: showOptionsToolCurveIntersectAxis(item); break;
    case IntersectCircleTangentTool::Type: showOptionsToolPointFromCircleAndTangent(item); break;
    case VToolPointFromArcAndTangent::Type: showOptionsToolPointFromArcAndTangent(item); break;
    case VToolTrueDarts::Type: showOptionsToolTrueDarts(item); break;
    case VToolRotation::Type: showOptionsToolRotation(item); break;
    case VToolMirrorByLine::Type: showOptionsToolMirrorByLine(item); break;
...
void VToolOptionsPropertyBrowser::updateOptions()
{
    ...
    case VToolBasePoint::Type: updateOptionsToolSinglePoint(); break;
    case VToolEndLine::Type: updateOptionsToolEndLine(); break;
    case VToolAlongLine::Type: updateOptionsToolAlongLine(); break;
    case VToolArc::Type: updateOptionsToolArc(); break;
    case VToolArcWithLength::Type: updateOptionsToolArcWithLength(); break;
    case VToolBisector::Type: updateOptionsToolBisector(); break;
    case VToolCutArc::Type: updateOptionsToolCutArc(); break;
    case VToolCutSpline::Type: updateOptionsToolCutSpline(); break;
    case VToolCutSplinePath::Type: updateOptionsToolCutSplinePath(); break;
    case VToolHeight::Type: updateOptionsToolHeight(); break;
    case VToolLine::Type: updateOptionsToolLine(); break;
    case VToolLineIntersect::Type: updateOptionsToolLineIntersect(); break;
    case VToolNormal::Type: updateOptionsToolNormal(); break;
    case VToolPointOfContact::Type: updateOptionsToolPointOfContact(); break;
    case PointIntersectXYTool::Type: updateOptionsToolPointOfIntersection(); break;
    case VToolPointOfIntersectionArcs::Type: updateOptionsToolPointOfIntersectionArcs(); break;
    case IntersectCirclesTool::Type: updateOptionsToolPointOfIntersectionCircles(); break;
    case VToolPointOfIntersectionCurves::Type: updateOptionsToolPointOfIntersectionCurves(); break;
    case VToolShoulderPoint::Type: updateOptionsToolShoulderPoint(); break;
    case VToolSpline::Type: updateOptionsToolSpline(); break;
    case VToolCubicBezier::Type: updateOptionsToolCubicBezier(); break;
    case VToolSplinePath::Type: updateOptionsToolSplinePath(); break;
    case VToolCubicBezierPath::Type: updateOptionsToolCubicBezierPath(); break;
    case VToolTriangle::Type: updateOptionsToolTriangle(); break;
    case VGraphicsSimpleTextItem::Type:
    case VControlPointSpline::Type: showItemOptions(currentItem->parentItem()); break;
    case VToolLineIntersectAxis::Type: updateOptionsToolLineIntersectAxis(); break;
    case VToolCurveIntersectAxis::Type: updateOptionsToolCurveIntersectAxis(); break;
    case IntersectCircleTangentTool::Type: updateOptionsToolPointFromCircleAndTangent(); break;
    case VToolPointFromArcAndTangent::Type: updateOptionsToolPointFromArcAndTangent(); break;
    case VToolTrueDarts::Type: updateOptionsToolTrueDarts(); break;
    case VToolRotation::Type: updateOptionsToolRotation(); break;
    case VToolMirrorByLine::Type: updateOptionsToolMirrorByLine(); break;
...
void VToolOptionsPropertyBrowser::userChangedData(VPE::VProperty* property)
{
    ...
    switch (currentItem->type()) {
    case VToolBasePoint::Type: changeDataToolSinglePoint(prop); break;
    case VToolEndLine::Type: changeDataToolEndLine(prop); break;
    case VToolAlongLine::Type: changeDataToolAlongLine(prop); break;
    case VToolArc::Type: changeDataToolArc(prop); break;
    case VToolArcWithLength::Type: changeDataToolArcWithLength(prop); break;
    case VToolBisector::Type: changeDataToolBisector(prop); break;
    case VToolCutArc::Type: changeDataToolCutArc(prop); break;
    case VToolCutSpline::Type: changeDataToolCutSpline(prop); break;
    case VToolCutSplinePath::Type: changeDataToolCutSplinePath(prop); break;
    case VToolHeight::Type: changeDataToolHeight(prop); break;
    case VToolLine::Type: changeDataToolLine(prop); break;
    case VToolLineIntersect::Type: changeDataToolLineIntersect(prop); break;
    case VToolNormal::Type: changeDataToolNormal(prop); break;
    case VToolPointOfContact::Type: changeDataToolPointOfContact(prop); break;
    case PointIntersectXYTool::Type: changeDataToolPointOfIntersection(prop); break;
    case VToolPointOfIntersectionArcs::Type: changeDataToolPointOfIntersectionArcs(prop); break;
    case IntersectCirclesTool::Type: changeDataToolPointOfIntersectionCircles(prop); break;
    case VToolPointOfIntersectionCurves::Type: changeDataToolPointOfIntersectionCurves(prop); break;
    case VToolShoulderPoint::Type: changeDataToolShoulderPoint(prop); break;
    case VToolSpline::Type: changeDataToolSpline(prop); break;
    case VToolCubicBezier::Type: changeDataToolCubicBezier(prop); break;
    case VToolSplinePath::Type: changeDataToolSplinePath(prop); break;
    case VToolCubicBezierPath::Type: changeDataToolCubicBezierPath(prop); break;
    case VToolTriangle::Type: changeDataToolTriangle(prop); break;
    case VToolLineIntersectAxis::Type: changeDataToolLineIntersectAxis(prop); break;
    case VToolCurveIntersectAxis::Type: changeDataToolCurveIntersectAxis(prop); break;
    case IntersectCircleTangentTool::Type: changeDataToolPointFromCircleAndTangent(prop); break;
    case VToolPointFromArcAndTangent::Type: changeDataToolPointFromArcAndTangent(prop); break;
    case VToolTrueDarts::Type: changeDataToolTrueDarts(prop); break;
    case VToolRotation::Type: changeDataToolRotation(prop); break;
    case VToolMirrorByLine::Type: changeDataToolMirrorByLine(prop); break;
...
//---------------------------------------------------------------------------------------------------------------------
void VToolOptionsPropertyBrowser::addPropertyFormula(
    const QString& propertyName, const VFormula& formula, const QString& attrName)
{
...
void VToolOptionsPropertyBrowser::addPropertyObjectName(
    Tool* tool, const QString& propertyName, bool readOnly)
{
...
//---------------------------------------------------------------------------------------------------------------------
template <class Tool>
void VToolOptionsPropertyBrowser::addPropertyOperationSuffix(
    Tool* tool, const QString& propertyName, bool readOnly)
{
...
//---------------------------------------------------------------------------------------------------------------------
template <class Tool>
void VToolOptionsPropertyBrowser::addPropertyLineName(
    Tool* tool, const QString& propertyName, bool readOnly)
{
...
//---------------------------------------------------------------------------------------------------------------------
template <class Tool>
void VToolOptionsPropertyBrowser::addPropertyCurveName(
    Tool* tool,
...
//---------------------------------------------------------------------------------------------------------------------
void VToolOptionsPropertyBrowser::addPropertyParentPointName(
    const QString& pointName, const QString& propertyName, const QString& propertyAttribute)
{
...
//---------------------------------------------------------------------------------------------------------------------
void VToolOptionsPropertyBrowser::addPropertyLabel(
    const QString& propertyName, const QString& propertyAttribute)
{
...
void VToolOptionsPropertyBrowser::addPropertyCurveLineType(Tool* tool, const QString& propertyName)
{
    ...
    const qint32 index =
        VPE::LineTypeProperty::indexOfLineType(curveLineTypeList(), tool->GetPenStyle());
    if (index == -1) {
        qWarning() << "Can't find line type" << tool->getLineType() << "in list";
    }
...
void VToolOptionsPropertyBrowser::addPropertyLineWeight(Tool* tool, const QString& propertyName)
{
    ...
    const qint32 index =
        VPE::LineWeightProperty::indexOfLineWeight(lineWeightList(), tool->getLineWeight());
    if (index == -1) {
...
//---------------------------------------------------------------------------------------------------------------------
template <class Tool>
void VToolOptionsPropertyBrowser::addPropertyLineColor(
    Tool* tool, const QString& propertyName, const QString& id)
{
    ...
    const qint32 index =
        VPE::VLineColorProperty::indexOfColor(VAbstractTool::ColorsList(), tool->getLineColor());
    if (index == -1) {
...
//---------------------------------------------------------------------------------------------------------------------
template <class Tool>
void VToolOptionsPropertyBrowser::addObjectProperty(
    Tool* tool,
        ...
        if (recId != toolId) {
            ...
            case 48:   // Tool::Move
            {
                QVector<quint32> list =
                    qApp->getCurrentDocument()->getOpItems(recId, QStringLiteral("destination"));
                for (qint32 j = 0; j < list.size(); ++j) {
                    quint32 id = list.at(j);
                    VToolRecord newRecord = VToolRecord(
                        id, record.typeTool, qApp->getCurrentDocument()->getActiveDraftBlockName());
    ...
    for (i = objects.constBegin(); i != objects.constEnd(); ++i) {
        ...
        if (obj->getMode() == Draw::Calculation) {
            ...
            case GOType::AllCurves:
                if ((obj->getType() == GOType::Spline || obj->getType() == GOType::SplinePath
                     || obj->getType() == GOType::CubicBezier
                     || obj->getType() == GOType::CubicBezierPath || obj->getType() == GOType::Arc
...
Type VToolOptionsPropertyBrowser::getCrossPoint(const QVariant& value)
{
    ...
    if (ok) {
        switch (val) {
        case 0:
        case 1: cross = static_cast<Type>(val + 1); break;
        default: break;
        }
    }
...
void VToolOptionsPropertyBrowser::changeDataToolPointOfIntersectionArcs(VPE::VProperty* property)
{
    ...
    VToolPointOfIntersectionArcs* tool =
        qgraphicsitem_cast<VToolPointOfIntersectionArcs*>(currentItem);
    SCASSERT(tool != nullptr)
    switch (propertiesList().indexOf(id)) {
    case 0:   // AttrName
...
void VToolOptionsPropertyBrowser::changeDataToolPointOfIntersectionCurves(VPE::VProperty* property)
{
    ...
    VToolPointOfIntersectionCurves* tool =
        qgraphicsitem_cast<VToolPointOfIntersectionCurves*>(currentItem);
    SCASSERT(tool != nullptr)
    switch (propertiesList().indexOf(id)) {
    case 0:   // AttrName
...
void VToolOptionsPropertyBrowser::changeDataToolPointFromArcAndTangent(VPE::VProperty* property)
{
    ...
    VToolPointFromArcAndTangent* tool =
        qgraphicsitem_cast<VToolPointFromArcAndTangent*>(currentItem);
    SCASSERT(tool != nullptr)
    switch (propertiesList().indexOf(id)) {
    case 0:   // AttrName
...
void VToolOptionsPropertyBrowser::showOptionsToolAlongLine(QGraphicsItem* item)
{
    ...
    addPropertyObjectName(tool, tr("Name:"));
    addObjectProperty(
        tool, tool->BasePointName(), tr("First point:"), AttrBasePoint, GOType::Point);
    addObjectProperty(
        tool, tool->SecondPointName(), tr("Second point:"), AttrSecondPoint, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolArc(QGraphicsItem* item)
{
    ...
    addPropertyCurveName(
        ...
        QString().setNum(tool->getId()),
        true);
    addObjectProperty(
        tool, tool->CenterPointName(), tr("Center point:"), AttrCenter, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolBisector(QGraphicsItem* item)
{
    ...
    addPropertyObjectName(tool, tr("Name:"));
    addObjectProperty(
        tool, tool->FirstPointName(), tr("First point:"), AttrFirstPoint, GOType::Point);
    addObjectProperty(
        tool, tool->BasePointName(), tr("Second point:"), AttrBasePoint, GOType::Point);
    addObjectProperty(
        tool, tool->ThirdPointName(), tr("Third point:"), AttrThirdPoint, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolTrueDarts(QGraphicsItem* item)
{
    ...
    addObjectProperty(
        tool, tool->BaseLineP1Name(), tr("First base point:"), AttrFirstPoint, GOType::Point);
    addObjectProperty(
        tool, tool->BaseLineP2Name(), tr("Second base point:"), AttrSecondPoint, GOType::Point);
    addObjectProperty(tool, tool->DartP1Name(), tr("First dart point:"), AttrDartP1, GOType::Point);
    addObjectProperty(
        tool, tool->DartP2Name(), tr("Second dart point:"), AttrDartP2, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolHeight(QGraphicsItem* item)
{
    ...
    addObjectProperty(tool, tool->BasePointName(), tr("Base point:"), AttrBasePoint, GOType::Point);
    addObjectProperty(
        tool, tool->FirstLinePointName(), tr("First line point:"), AttrP1Line, GOType::Point);
    addObjectProperty(
        tool, tool->SecondLinePointName(), tr("Second line point:"), AttrP2Line, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolPointOfContact(QGraphicsItem* item)
{
    ...
    addPropertyObjectName(tool, tr("Name:"));
    addObjectProperty(
        tool, tool->ArcCenterPointName(), tr("Center of arc:"), AttrCenter, GOType::Point);
    addObjectProperty(
        tool, tool->FirstPointName(), tr("1st line point:"), AttrFirstPoint, GOType::Point);
    addObjectProperty(
        tool, tool->SecondPointName(), tr("2nd line point:"), AttrSecondPoint, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolPointOfIntersectionCircles(QGraphicsItem* item)
{
    ...
    addObjectProperty(
        tool, tool->FirstCircleCenterPointName(), tr("Center:"), AttrC1Center, GOType::Point);
    addPropertyFormula(tr("Radius:"), tool->GetFirstCircleRadius(), AttrC1Radius);

    addPropertyLabel(tr("Second circle:"), AttrName);
    addObjectProperty(
        tool, tool->SecondCircleCenterPointName(), tr("Center:"), AttrC2Center, GOType::Point);
...
{
    VToolPointOfIntersectionCurves* tool =
        qgraphicsitem_cast<VToolPointOfIntersectionCurves*>(item);
    tool->ShowVisualization(true);
    ...
    addPropertyObjectName(tool, tr("Name:"));
    addObjectProperty(
        tool, tool->FirstCurveName(), tr("First curve:"), AttrCurve1, GOType::AllCurves);
    addObjectProperty(
        tool, tool->SecondCurveName(), tr("Second curve:"), AttrCurve2, GOType::AllCurves);
...
void VToolOptionsPropertyBrowser::showOptionsToolPointFromCircleAndTangent(QGraphicsItem* item)
{
    ...
    addPropertyObjectName(tool, tr("Name:"));
    addObjectProperty(
        tool, tool->CircleCenterPointName(), tr("Center point:"), AttrCCenter, GOType::Point);
    addObjectProperty(
        tool, tool->TangentPointName(), tr("Tangent point:"), AttrTangent, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolShoulderPoint(QGraphicsItem* item)
{
    ...
    addObjectProperty(
        tool, tool->SecondPointName(), tr("Second point:"), AttrSecondPoint, GOType::Point);
    addObjectProperty(
        tool, tool->ShoulderPointName(), tr("Third point:"), AttrThirdPoint, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolSpline(QGraphicsItem* item)
{
    ...
    addPropertyLabel(tr("Selection"), AttrName);
    addPropertyCurveName(
        tool, tr("Name:"), tr("Spl_"), spl.GetP1().name(), spl.GetP4().name(), true);

    addObjectProperty(tool, spl.GetP1().name(), tr("First point:"), AttrFirstPoint, GOType::Point);
    addObjectProperty(
        tool, spl.GetP4().name(), tr("Second point:"), AttrSecondPoint, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolSplinePath(QGraphicsItem* item)
{
    ...
    addPropertyLabel(tr("Selection"), AttrName);
    addPropertyCurveName(
        tool, tr("Name:"), tr("SplPath_"), spl.FirstPoint().name(), spl.LastPoint().name(), true);
    addPropertyLabel(tr("Attributes"), AttrName);
    addPropertyLineColor(tool, tr("Color:"), AttrColor);
    addPropertyCurveLineType(tool, tr("Linetype:"));
    addPropertyLineWeight(tool, tr("Lineweight:"));
...
void VToolOptionsPropertyBrowser::showOptionsToolLineIntersectAxis(QGraphicsItem* item)
{
    ...
    addObjectProperty(
        tool, tool->FirstLinePoint(), tr("First point:"), AttrFirstPoint, GOType::Point);
    addObjectProperty(
        tool, tool->SecondLinePoint(), tr("Second point:"), AttrSecondPoint, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolRotation(QGraphicsItem* item)
{
    ...
    addPropertyLabel(tr("Selection"), AttrName);
    addObjectProperty(
        tool, tool->getOriginPointName(), tr("Rotation point:"), AttrCenter, GOType::Point);
...
void VToolOptionsPropertyBrowser::showOptionsToolMirrorByAxis(QGraphicsItem* item)
{
    ...
    addPropertyLabel(tr("Selection"), AttrName);
    addObjectProperty(
        tool, tool->getOriginPointName(), tr("Axis point:"), AttrCenter, GOType::Point);
...
void VToolOptionsPropertyBrowser::updateOptionsToolEndLine()
{
    ...
    {
        const qint32 index = VPE::VLineColorProperty::indexOfColor(
    ...
    {
        const qint32 index =
            VPE::LineTypeProperty::indexOfLineType(lineTypeList(), tool->getLineType());
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->BasePointName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolAlongLine()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->SecondPointName());
...
{
    VToolArc* tool = qgraphicsitem_cast<VToolArc*>(currentItem);
    idToProperty[AttrObjName]->setValue(
        tr("Arc_") + tool->CenterPointName() + "_" + QString().setNum(tool->getId()));
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->CenterPointName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolBisector()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->FirstPointName());
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->ThirdPointName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolTrueDarts()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->BaseLineP1Name());
        idToProperty[AttrFirstPoint]->setValue(index);
    }
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->BaseLineP2Name());
        idToProperty[AttrSecondPoint]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->DartP1Name());
        idToProperty[AttrDartP1]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->DartP2Name());
        idToProperty[AttrDartP2]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->DartP3Name());
...
void VToolOptionsPropertyBrowser::updateOptionsToolCutArc()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Arc), tool->CurveName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolCutSpline()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Spline), tool->CurveName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolCutSplinePath()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::SplinePath), tool->CurveName());
        idToProperty[AttrCurve]->setValue(index);
    }
...
void VToolOptionsPropertyBrowser::updateOptionsToolHeight()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->FirstLinePointName());
        idToProperty[AttrP1Line]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->SecondLinePointName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolLine()
{
    ...
    idToProperty[AttrObjName]->setValue(
        tr("Line_") + tool->FirstPointName() + "_" + tool->SecondPointName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolLineIntersect()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->Line1P1Name());
        idToProperty[AttrP1Line1]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->Line1P2Name());
        idToProperty[AttrP2Line1]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->Line2P1Name());
        idToProperty[AttrP1Line2]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->Line2P2Name());
...
void VToolOptionsPropertyBrowser::updateOptionsToolPointOfContact()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->ArcCenterPointName());
        idToProperty[AttrCenter]->setValue(index);
    }
...
void VToolOptionsPropertyBrowser::updateOptionsToolPointOfIntersectionArcs()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Arc), tool->FirstArcName());
        idToProperty[AttrFirstArc]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Arc), tool->SecondArcName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolPointOfIntersectionCircles()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->FirstCircleCenterPointName());
        idToProperty[AttrC1Center]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->SecondCircleCenterPointName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolPointOfIntersectionCurves()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->FirstCurveName());
        idToProperty[AttrCurve1]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->SecondCurveName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolPointFromCircleAndTangent()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->CircleCenterPointName());
        idToProperty[AttrCCenter]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->TangentPointName());
...
void VToolOptionsPropertyBrowser::updateOptionsToolPointFromArcAndTangent()
{
    ...
    {
        const qint32 index =
            VPE::VObjectProperty::indexOfObject(getObjectList(tool, GOType::Arc), tool->ArcName());
        idToProperty[AttrArc]->setValue(index);
    }
}
...
void VToolOptionsPropertyBrowser::updateOptionsToolShoulderPoint()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->ShoulderPointName());
        idToProperty[AttrThirdPoint]->setValue(index);
    }
}
...
void VToolOptionsPropertyBrowser::updateOptionsToolSpline()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), spl.GetP1().name());
        idToProperty[AttrFirstPoint]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), spl.GetP4().name());
        idToProperty[AttrSecondPoint]->setValue(index);
    }
...
void VToolOptionsPropertyBrowser::updateOptionsToolCubicBezier()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), spl.GetP2().name());
        idToProperty[AttrPoint2]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), spl.GetP3().name());
...
void VToolOptionsPropertyBrowser::updateOptionsToolTriangle()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->AxisP1Name());
        idToProperty[AttrAxisP1]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->AxisP2Name());
...
void VToolOptionsPropertyBrowser::updateOptionsToolLineIntersectAxis()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->FirstLinePoint());
        idToProperty[AttrFirstPoint]->setValue(index);
    }

    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->SecondLinePoint());
        idToProperty[AttrSecondPoint]->setValue(index);
    }
...
void VToolOptionsPropertyBrowser::updateOptionsToolCurveIntersectAxis()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::AllCurves), tool->CurveName());
        idToProperty[AttrCurve]->setValue(index);
    }
...
void VToolOptionsPropertyBrowser::updateOptionsToolRotation()
{
    ...
    {
        const qint32 index = VPE::VObjectProperty::indexOfObject(
            getObjectList(tool, GOType::Point), tool->getOriginPointName());
        idToProperty[AttrCenter]->setValue(index);
    }
}
