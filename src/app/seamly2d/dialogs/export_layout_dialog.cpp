...
ExportLayoutDialog::ExportLayoutDialog(
    int count, Draw mode, const QString& fileName, QWidget* parent)
    ...
    , m_SaveButton(nullptr)
{
    ...
    ui->filename_LineEdit->setValidator(
        new QRegularExpressionValidator(QRegularExpression(fileNameRegExp), this));
    ...
    connect(
        ui->filename_LineEdit, &QLineEdit::textChanged, this, &ExportLayoutDialog::showExportFiles);
    connect(
        ui->format_ComboBox,
        static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),
        this,
        &ExportLayoutDialog::showExportFiles);
    connect(ui->browse_PushButton, &QPushButton::clicked, this, [this]() {
        ...
        if (!dir.isEmpty()) {   // If the paths are equal the slot will not be called, we will do
                                // this manually
...
void ExportLayoutDialog::setBinaryDXFFormat(bool binary)
{
    ...
    case LayoutExportFormat::DXF_AC1027_ASTM: ui->binaryDXF_CheckBox->setChecked(binary); break;
    ...
    default: ui->binaryDXF_CheckBox->setChecked(false); break;
    }
}
...
bool ExportLayoutDialog::isBinaryDXFFormat() const
{
    ...
    case LayoutExportFormat::DXF_AC1021_ASTM:
    case LayoutExportFormat::DXF_AC1024_ASTM:
    case LayoutExportFormat::DXF_AC1027_ASTM: return ui->binaryDXF_CheckBox->isChecked();
    case LayoutExportFormat::SVG:
    case LayoutExportFormat::PDF:
    case LayoutExportFormat::PDFTiled:
    case LayoutExportFormat::PNG:
...
//---------------------------------------------------------------------------------------------------------------------
QString ExportLayoutDialog::fileName() const { return ui->filename_LineEdit->text(); }
...
//---------------------------------------------------------------------------------------------------------------------
QString ExportLayoutDialog::formatText() const { return ui->format_ComboBox->currentText(); }
...
void ExportLayoutDialog::showExportFiles()
{
    ...
    case LayoutExportFormat::DXF_AC1021_ASTM:
    case LayoutExportFormat::DXF_AC1024_ASTM:
    case LayoutExportFormat::DXF_AC1027_ASTM: ui->binaryDXF_CheckBox->setEnabled(true); break;
    case LayoutExportFormat::PDFTiled:
        ui->paperFormat_GroupBox->setEnabled(true);
        ui->margins_GroupBox->setEnabled(true);
        break;
    case LayoutExportFormat::PNG: ui->quality_Slider->setEnabled(true); break;
    case LayoutExportFormat::JPG: ui->quality_Slider->setEnabled(true); break;
    case LayoutExportFormat::PDF:
    case LayoutExportFormat::SVG:
    case LayoutExportFormat::BMP:
    case LayoutExportFormat::PPM:
    ...
    case LayoutExportFormat::EPS:
    case LayoutExportFormat::TIF:
    default: ui->binaryDXF_CheckBox->setEnabled(false); break;
    }
}

//---------------------------------------------------------------------------------------------------------------------
bool ExportLayoutDialog::isTextAsPaths() const { return ui->textAsPaths_Checkbox->isChecked(); }
