    ...
    , isInitialized(false)
{
    ...
    const QString file = QString(
                             ...
                             .arg(tr("Ctrl+S"))   // 9 & 10
                             .arg(tr("Save as"))
                             .arg(tr("Ctrl+Shift+S"))   // 11 &12
                             .arg(tr("Print"))
                             .arg(tr("Ctrl+P"))   // 13 & 14
                             .arg(tr("Pattern Preferences"))
                             .arg(tr("Ctrl+Shift+Comma"))   // 15 & 16
                             .arg(tr("Document Information"))
                             .arg(tr("Ctrl+I"))   // 17 & 18
                             .arg(tr("Exit"))
                             .arg(tr("Ctrl+Q"));   // 19 & 20
    ...
    const QString view = QString(
                             ...
                             .arg(tr("Zoom 1:1"))
                             .arg(tr("Ctrl+0"))   // 12 & 13
                             .arg(tr("Zoom to Point"))
                             .arg(tr("Ctrl+Alt+P"))   // 14 & 15
                             .arg(tr("Fit All"))
                             .arg(tr("Ctrl+="))   // 16 & 17
                             .arg(tr("Previous"))
                             .arg(tr("Ctrl+Left"))   // 18 & 19
                             .arg(tr("Selected"))
                             .arg(tr("Ctrl+Right"))   // 20 & 21
                             .arg(tr("Area"))
                             .arg(tr("Ctrl+A"))   // 22 & 23
                             .arg(tr("Pan"))
                             .arg(tr("Z, P"))   // 24 & 25
                             .arg(tr("Show Name Text"))
                             .arg(tr("V, P"))   // 26 & 27
                             .arg(tr("Increase Text Size"))
                             .arg(tr("Ctrl+]"))   // 28 & 29
                             .arg(tr("Decrease Text Size"))
                             .arg(tr("Ctrl+["))   // 30 & 31
                             .arg(tr("Use Tool Color"))
                             .arg(tr("T"))   // 32 & 33
                             .arg(tr("Wireframe"))
                             .arg(tr("V, W"))   // 34 & 35
                             .arg(tr("Curve Control Points"))
                             .arg(tr("V, C"))   // 36 & 37
                             .arg(tr("Axis Origin"))
                             .arg(tr("V, A"))   // 38 & 39
                             .arg(tr("Seam Allowance"))
                             .arg(tr("V, S"))   // 40 & 41
                             .arg(tr("Grainlines"))
                             .arg(tr("V, G"))   // 42 & 43
                             .arg(tr("Labels"))
    ...
    const QString measurements = QString(
                                     "<table style=font-size:11pt; font-weight:600>"
                                     "<tr><td width = 50%><b>%1</b></td><td></td></tr>"
                                     "<tr><td width = 50%>%2        </td><td>%3</td></tr>"
                                     "<tr><td width = 50%>%4        </td><td>%5</td></tr>"
                                     ...
                                     .arg(tr("Open SeamlyMe"))
                                     .arg(tr("Ctrl+M"))   // 2 & 3
                                     .arg(tr("Variables Table"))
                                     .arg(tr("Ctrl+T"))   // 4 & 5
                                     .arg(tr("Export Variables Table  to CSV"))
                                     .arg(tr("Ctrl+E"));   // 6 & 7

    const QString tools = QString(
                              "<table style=font-size:11pt; font-weight:600>"
                              "<tr><td width = 50%><b>%1</b></td><td></td></tr>"
                              "<tr><td width = 50%>%2        </td><td>%3</td></tr>"
                              "<tr><td width = 50%>%4        </td><td>%5<br></td></tr>"
                              "</table>")
                              .arg(tr("Tools"))   // 1
                              .arg(tr("New Draft Block"))
                              .arg(tr("Ctrl+Shift+N"))   // 2 & 3
                              .arg(tr("Rename Draft Block"))
                              .arg(tr("F2"));   // 4 & 5

    const QString points = QString(
                               "<table style=font-size:11pt; font-weight:600>"
                               "<tr><td width = 50%><b>%1</b></td><td></td></tr>"
                               "<tr><td width = 50%>%2        </td><td>%3</td></tr>"
                               "<tr><td width = 50%>%4        </td><td>%5</td></tr>"
                               ...
                               "</table>")
                               .arg(tr("Point"))   // 1
                               .arg(tr("Length and Angle"))
                               .arg(tr("L, A"))   // 2 & 3
                               .arg(tr("On Line"))
                               .arg(tr("O, L"))   // 4 & 5
                               .arg(tr("On Perpendicular"))
                               .arg(tr("O, P"))   // 6 & 7
                               .arg(tr("On Bisector"))
                               .arg(tr("O, B"))   // 8 & 9
                               .arg(tr("Length to Line"))
                               .arg(tr("P, S"))   // 10 & 11
                               .arg(tr("Intersect Arc and Line"))
                               .arg(tr("A, L"))   // 12 & 13
                               .arg(tr("Intersect Axis and Triangle"))
                               .arg(tr("X, T"))   // 14 & 15
                               .arg(tr("Intersect XY"))
                               .arg(tr("X, Y"))   // 16 & 17
                               .arg(tr("Intersect Line and Perpendicular"))
                               .arg(tr("L, P"))   // 18 & 19
                               .arg(tr("Intersect Line and Axis"))
                               .arg(tr("L, X"))   // 20 & 21
                               .arg(tr("Midpoint On Line"))
                               .arg(tr("Shift+O, Shift+L"));   // 22 & 23
    ...
    const QString line = QString(
                             ...
                             .arg(tr("Line"))
                             .arg(tr("Alt+L"))   // 2 & 3
                             .arg(tr("Point - Intersect Lines"))
                             .arg(tr("I, L"));   // 4 & 5

    const QString curves = QString(
                               "<table style=font-size:11pt; font-weight:600>"
                               "<tr><td width = 50%><b>%1</b></td><td></td></tr>"
                               "<tr><td width = 50%>%2       </td><td>%3</td></tr>"
                               "<tr><td width = 50%>%4       </td><td>%5</td></tr>"
                               ...
                               "</table>")
                               .arg(tr("Curves"))   // 1
                               .arg(tr("Curve - Interactive"))
                               .arg(tr("Alt+C"))   // 2 &3
                               .arg(tr("Spline - Interactive"))
                               .arg(tr("Alt+S"))   // 4 & 5
                               .arg(tr("Curve - Fixed"))
                               .arg(tr("Alt+Shift+C"))   // 6 & 7
                               .arg(tr("Spline - Fixed"))
                               .arg(tr("Alt+Shift+S"))   // 8 & 9
                               .arg(tr("Point - On Curve"))
                               .arg(tr("O, C"))   // 10 & 11
                               .arg(tr("Point - On Spline	"))
                               .arg(tr("O, S"))   // 12 & 13
                               .arg(tr("Point - Intersect Curves"))
                               .arg(tr("I, C"))   // 14 & 15
                               .arg(tr("Point - Intersect Curve and Axis"))
                               .arg(tr("C, X"));   // 16 & 17


    const QString arcs = QString(
                             "<table style=font-size:11pt; font-weight:600>"
                             "<tr><td width = 50%><b>%1</b></td><td></td></tr>"
                             "<tr><td width = 50%>%2       </td><td>%3</td></tr>"
                             "<tr><td width = 50%>%4       </td><td>%5</td></tr>"
                             ...
                             "</table>")
                             .arg(tr("Arcs"))   // 1
                             .arg(tr("Arc - Radius and Angle"))
                             .arg(tr("Alt+A"))   // 2 & 3
                             .arg(tr("Arc - Radius and Length"))
                             .arg(tr("Alt+Shift+A"))   // 4 & 5
                             .arg(tr("Point - On Arc"))
                             .arg(tr("O, A"))   // 6 & 7
                             .arg(tr("Point - Intersect Arc and Axis"))
                             .arg(tr("A, X"))   // 8 & 9
                             .arg(tr("Point - Intersect Arcs"))
                             .arg(tr("I, A"))   // 10 & 11
                             .arg(tr("Point - Intersect Circles"))
                             .arg(tr("Shift+I, Shift+C"))   // 12 & 13
                             .arg(tr("Point - Intersect Circle and Tangent"))
                             .arg(tr("C, T"))   // 14 & 15
                             .arg(tr("Point - Intersect Arc and Tangent"))
                             .arg(tr("A, T"))   // 16 & 17
                             .arg(tr("Elliptical Arc"))
                             .arg(tr("Alt+E"));   // 18 & 19


    const QString operations = QString(
                                   "<table style=font-size:11pt; font-weight:600>"
                                   "<tr><td width = 50%><b>%1</b></td><td></td></tr>"
                                   "<tr><td width = 50%>%2       </td><td>%3</td></tr>"
                                   "<tr><td width = 50%>%4       </td><td>%5</td></tr>"
                                   ...
                                   "</table>")
                                   .arg(tr("Operations"))   // 1
                                   .arg(tr("Add Objects to Group"))
                                   .arg(tr("G"))   // 2 & 3
                                   .arg(tr("Rotation"))
                                   .arg(tr("R"))   // 4 & 5
                                   .arg(tr("Mirror by Line"))
                                   .arg(tr("M, L"))   // 6 & 7
                                   .arg(tr("Mirror by Axis"))
                                   .arg(tr("M, A"))   // 8 & 9
                                   .arg(tr("Move"))
                                   .arg(tr("Alt+M"))   // 10 & 11
                                   .arg(tr("True Darts"))
                                   .arg(tr("T, D"))   // 12 & 13
                                   .arg(tr("Export Draft Blocks"))
                                   .arg(tr("E, D"));   // 14 & 15
    ...
    const QString pattern = QString(
                                ...
                                .arg(tr("New Pattern Piece"))
                                .arg(tr("N, P"))   // 2 & 3
                                .arg(tr("Anchor Point"))
                                .arg(tr("A, P"))   // 4 & 5
                                .arg(tr("Internal Path"))
                                .arg(tr("I, P"))   // 6 & 7
                                .arg(tr("Insert Nodes"))
                                .arg(tr("I, N"))   // 8 & 9
                                .arg(tr("Edit Properties"))
                                .arg(tr("P"))   // 10 & 11
                                .arg(tr("Toggle Lock"))
                                .arg(tr("Ctrl+L"))   // 12 & 13
                                .arg(tr("Include in Layout"))
                                .arg(tr("I"))   // 14 & 15
                                .arg(tr("Forbid Flipping"))
                                .arg(tr("F"))   // 16 & 17
                                .arg(tr("Raise To Top"))
                                .arg(tr("Ctrl+Home"))   // 18 & 19
                                .arg(tr("Lower To Bottom"))
                                .arg(tr("Ctrl+End"))   // 20 & 21
                                .arg(tr("Rename"))
                                .arg(tr("F2"))   // 21 & 23
                                .arg(tr("Delete"))
                                .arg(tr("Del"));   // 24 & 25
    ...
    const QString layout = QString(
                               ...
                               .arg(tr("New Layout"))
                               .arg(tr("N, L"))   // 2 & 3
                               .arg(tr("Export Layout"))
                               .arg(tr("E, L"))   // 4 & 5
                               .arg(tr("Last Tool"))
                               .arg(tr("Ctrl+Shift+L"));   // 6 & 7
    ...
    const QString utilities = QString(
                                  "<table style=font-size:11pt; font-weight:600>"
                                  "<tr><td width = 50%><b>%1</b></td><td></td></tr>"
                                  "<tr><td width = 50%>%2       </td><td>%3</td></tr>"
                                  "<tr><td width = 50%>%4       </td><td>%5<br></td></tr>"
                                  ...
                                  .arg(tr("Utilities"))   // 1
                                  .arg(tr("Calculator"))
                                  .arg(tr("Ctrl+Shift+C"))   // 2 & 3
                                  .arg(tr("Decimal Chart"))
                                  .arg(tr("Ctrl+Shift+D"));   // 4 & 5
    ...
    ui->shortcuts_TextBrowser->setHtml(
        file + edit + view + measurements + tools + points + line + curves + arcs + operations
        + pattern + details + layout + history + utilities + help);

    // Limit dialog height to 80% of screen size
    setMaximumHeight(qRound(QGuiApplication::primaryScreen()->availableGeometry().height() * .8));

    connect(
        ui->clipboard_ToolButton, &QToolButton::clicked, this, &ShortcutsDialog::copyToClipboard);
