...
void VTranslateVars::InitPatternMakingSystems()
{
    ...
    book =
        translate("VTranslateVars", "The Great War: Styles and Patterns of the 1910s", "Book name");
    InitSystem(p8_S, name, author, book);
    //=================================================================================================================
    name = translate("VTranslateVars", "Hillhouse & Mansfield", "System name");
    author =
        translate("VTranslateVars", "Marion S. Hillhouse and Evelyn A. Mansfield", "Author name");
    book =
        translate("VTranslateVars", "Dress Design: Draping and Flat Pattern Making", "Book name");
    ...
    book =
        translate("VTranslateVars", "The Complete Guide to Practical Cutting (1853)", "Book name");
    ...
    book = translate(
        "VTranslateVars", "K.Kimata's Simplified Drafting Book for Dressmaking", "Book name");
    ...
    book = translate(
        "VTranslateVars", "Dorothy Moore's Pattern Drafting and Dressmaking", "Book name");
    ...
    author = translate(
        "VTranslateVars", "Shri K. R. Zarapkar and Shri Arvind K. Zarapkar", "Author name");
    ...
    book = translate(
        "VTranslateVars", "Men's 17th & 18th Century Costume, Cut & Fashion", "Book name");
    ...
    book = translate(
        "VTranslateVars", "The Victorian Tailor: An Introduction to Period Tailoring", "Book name");
    ...
    author =
        translate("VTranslateVars", "Ministry of consumer industry of the USSR", "Author name");
    ...
    author =
        translate("VTranslateVars", "Josephine F. Eddy and Elizabeth C. B. Wiley", "Author name");
    ...
    author = translate("VTranslateVars", "Seamly2D team", "Author name");
    book = translate("VTranslateVars", "Seamly2D's internal standard", "Book name");
...
{
    variables.insert(
        measurement_, translate("VTranslateVars", "M_", "Leave the _ symbol in translation"));
    variables.insert(
        variable_, translate("VTranslateVars", "Variable_", "Leave the _ symbol in translation"));
    variables.insert(
        line_, translate("VTranslateVars", "Line_", "Leave the _ symbol in translation"));
    variables.insert(
        angleLine_, translate("VTranslateVars", "AngleLine_", "Leave the _ symbol in translation"));
    variables.insert(
        arc_, translate("VTranslateVars", "Arc_", "Leave the _ symbol in translation"));
    variables.insert(
        elarc_, translate("VTranslateVars", "ElArc_", "Leave the _ symbol in translation"));
    variables.insert(
        spl_, translate("VTranslateVars", "Spl_", "Leave the _ symbol in translation"));
    variables.insert(
        splPath,
        translate("VTranslateVars", "SplPath", "Do not add symbol _ to the end of the name"));
    variables.insert(
        radiusArc_, translate("VTranslateVars", "RadiusArc_", "Leave the _ symbol in translation"));
    variables.insert(
        radius1ElArc_,
        translate("VTranslateVars", "Radius1ElArc_", "Leave the _ symbol in translation"));
    variables.insert(
        radius2ElArc_,
        translate("VTranslateVars", "Radius2ElArc_", "Leave the _ symbol in translation"));
    variables.insert(
        angle1Arc_, translate("VTranslateVars", "Angle1Arc_", "Leave the _ symbol in translation"));
    variables.insert(
        angle2Arc_, translate("VTranslateVars", "Angle2Arc_", "Leave the _ symbol in translation"));
    variables.insert(
        angle1ElArc_,
        translate("VTranslateVars", "Angle1ElArc_", "Leave the _ symbol in translation"));
    variables.insert(
        angle2ElArc_,
        translate("VTranslateVars", "Angle2ElArc_", "Leave the _ symbol in translation"));
    variables.insert(
        angle1Spl_, translate("VTranslateVars", "Angle1Spl_", "Leave the _ symbol in translation"));
    variables.insert(
        angle2Spl_, translate("VTranslateVars", "Angle2Spl_", "Leave the _ symbol in translation"));
    variables.insert(
        angle1SplPath,
    ...
    variables.insert(
        seg_, translate("VTranslateVars", "Seg_", "Segment. Leave the _ symbol in translation"));
    variables.insert(
        currentLength,
        translate("VTranslateVars", "CurrentLength", "Do not add space between words"));
    variables.insert(
        currentSeamAllowance,
        translate("VTranslateVars", "CurrentSeamAllowance", "Do not add space between words"));
    variables.insert(
        c1LengthSpl_,
        translate("VTranslateVars", "C1LengthSpl_", "Leave the _ symbol in translation"));
    variables.insert(
        c2LengthSpl_,
        translate("VTranslateVars", "C2LengthSpl_", "Leave the _ symbol in translation"));
    variables.insert(
        c1LengthSplPath,
        translate(
            "VTranslateVars", "C1LengthSplPath", "Do not add symbol _ to the end of the name"));
    variables.insert(
        c2LengthSplPath,
        translate(
            "VTranslateVars", "C2LengthSplPath", "Do not add symbol _ to the end of the name"));
}
...
void VTranslateVars::InitFunctions()
{
    ...
    functions.insert(
        sinh_F,
        translate(
            "VTranslateVars", "sinh", "Hyperbolic sine function\nUsage: sinh(angle θ in radians)"));
    functions.insert(
        cosh_F,
        translate("VTranslateVars", "cosh", "Hyperbolic cosine\nUsage: cosh(angle θ in radians)"));
    functions.insert(
        tanh_F,
        translate(
            "VTranslateVars",
    ...
    functions.insert(
        asinh_F,
        translate("VTranslateVars", "asinh", "Inverse Hyperbolic sine function\nUsage: asinh(x)"));
    functions.insert(
        acosh_F,
        translate(
            "VTranslateVars", "acosh", "Inverse Hyperbolic cosine function\nUsage: acosh(x)"));
    functions.insert(
        atanh_F,
        translate(
            "VTranslateVars", "atanh", "Inverse Hyperbolic tangent function\nUsage: atanh(x)"));
    functions.insert(
        sinD_F,
        translate(
            "VTranslateVars",
    ...
    functions.insert(
        log2_F, translate("VTranslateVars", "log2", "Logarithm to the base 2\nUsage: log2(x)"));
    functions.insert(
        log10_F, translate("VTranslateVars", "log10", "Logarithm to the base 10\nUsage: log10(x)"));
    functions.insert(
        log_F, translate("VTranslateVars", "log", "Logarithm to the base 10\nUsage: log(x)"));
    functions.insert(
        ln_F, translate("VTranslateVars", "ln", "Logarithm to base e (2.71828...)\nUsage: ln(x)"));
    functions.insert(
        exp_F,
        translate(
            "VTranslateVars", "exp", "E raised to the power of x\nUsage: exp(x) where e = 2.718"));
    functions.insert(
        sqrt_F, translate("VTranslateVars", "sqrt", "Square root of a value\nUsage: sqrt(x)"));
    functions.insert(
        sign_F,
        translate("VTranslateVars", "sign", "Sign function -1 if x<0; 1 if x>0\nUsage: sign(x)"));
    functions.insert(
        rint_F,
        translate("VTranslateVars", "rint", "Round to nearest integer\nUsage: rint(float x)"));
    functions.insert(abs_F, translate("VTranslateVars", "abs", "Absolute value\nUsage: abs(x)"));
    functions.insert(
        min_F,
        translate(
            "VTranslateVars", "min", "Min of all arguments\nUsage: min(arg 1; arg 2; ... arg n)"));
    functions.insert(
        max_F,
        translate(
            "VTranslateVars", "max", "Max of all arguments\nUsage: max(arg 1; arg 2; ... arg n)"));
    functions.insert(
        sum_F,
        translate(
            "VTranslateVars", "sum", "Sum of all arguments\nUsage: sum(arg 1; arg 2; ... arg n)"));
    functions.insert(
        avg_F,
        translate(
            "VTranslateVars",
...
void VTranslateVars::InitPlaceholder()
{
    ...
    placeholders.insert(
        pl_patternNumber, translate("VTranslateVars", "patternNumber", "placeholder"));
    ...
    placeholders.insert(
        pl_pOrientation, translate("VTranslateVars", "pOrientation", "placeholder"));
    ...
    placeholders.insert(
        pl_pFoldPosition, translate("VTranslateVars", "pFoldPosition", "placeholder"));
    ...
    placeholders.insert(
        pl_mInterfacing, translate("VTranslateVars", "mInterfacing", "placeholder"));
    placeholders.insert(
        pl_mInterlining, translate("VTranslateVars", "mInterlining", "placeholder"));
...
//---------------------------------------------------------------------------------------------------------------------
void VTranslateVars::InitSystem(
    const QString& code,
 ...
 *
 * Because translated string can have different length compare to original need make correction
 * after each translation. If bias = 0 correction will not happens.
 *
 ...
 */
void VTranslateVars::CorrectionsPositions(
...
void VTranslateVars::BiasTokens(int position, int bias, QMap<int, QString>& tokens)
{
    ...
    while (i != tokens.constEnd()) {
        if (i.key()
            <= position) {   // Tokens before position "position" did not change his positions.
 ...
 */
bool VTranslateVars::VariablesFromUser(
 ...
 */
bool VTranslateVars::PostfixOperatorsFromUser(
    QString& newFormula, int position, const QString& token, int& bias) const
{
 ...
 */
bool VTranslateVars::FunctionsFromUser(
    QString& newFormula, int position, const QString& token, int& bias) const
{
 ...
 * @return true if was found variable with same name.
 */
bool VTranslateVars::VariablesToUser(
    QString& newFormula, int position, const QString& token, int& bias) const
{
    QMap<QString, qmu::QmuTranslation>::const_iterator i = variables.constBegin();
    while (i != variables.constEnd()) {
...
QString VTranslateVars::FormulaFromUser(const QString& formula, bool osSeparator) const
{
    ...
    const qmu::QmuTokenParser cal{ formula, osSeparator };   // Eval formula
    QMap<int, QString> tokens = cal.GetTokens();             // Tokens (variables, measurements)
    QMap<int, QString> numbers =
        cal.GetNumbers();   // All numbers in expression for changing decimal separator
    ...
    for (int i = 0; i < tKeys.size(); ++i) {
        ...
        if (MeasurementsFromUser(newFormula, tKeys.at(i), tValues.at(i), bias)) {
            if (bias != 0) {   // Translated token has different length than original. Position next
                               // tokens need to be corrected.
        ...
        if (tValues.at(i) == QLocale().negativeSign()) {   // unary minus
            newFormula.replace(tKeys.at(i), 1, '-');
        }
    }

    QLocale loc = QLocale();                    // User locale
    if (loc != QLocale::c() && osSeparator) {   // User want use Os separator
        ...
        for (int i = 0; i < nKeys.size(); ++i) {
            ...
            if (bias != 0) {   // Translated number has different length than original. Position
...
QString VTranslateVars::FormulaToUser(const QString& formula, bool osSeparator) const
{
    ...
    for (int i = 0; i < tKeys.size(); ++i) {
        if (m_measurements.contains(tValues.at(i))) {
            ...
            int bias =
                tValues.at(i).length() - m_measurements.value(tValues.at(i)).translate().length();
            if (bias != 0) {   // Translated token has different length than original. Position next
                               // tokens need to be corrected.
                CorrectionsPositions(tKeys.at(i), bias, tokens, numbers);
                tKeys = tokens.keys();
        ...
        if (functions.contains(tValues.at(i))) {
            newFormula.replace(
                tKeys.at(i), tValues.at(i).length(), functions.value(tValues.at(i)).translate());
        ...
        if (postfixOperators.contains(tValues.at(i))) {
            ...
            int bias =
                tValues.at(i).length() - postfixOperators.value(tValues.at(i)).translate().length();
            if (bias != 0) {   // Translated token has different length than original. Position next
                               // tokens need to be corrected.
                CorrectionsPositions(tKeys.at(i), bias, tokens, numbers);
                tKeys = tokens.keys();
        ...
        if (tValues.at(i) == QChar('-')) {   // unary minus
...
//---------------------------------------------------------------------------------------------------------------------
QMap<QString, qmu::QmuTranslation> VTranslateVars::getFunctions() const { return functions; }
