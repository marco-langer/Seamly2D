 ...
 */
bool VTranslateMeasurements::MeasurementsFromUser(
...
//---------------------------------------------------------------------------------------------------------------------
void VTranslateMeasurements::InitMeasurement(
    const QString& name,
...
{
    // Note. We can't use here function and variables because lupdate tool doesn't see string in
    // variables and doesn't mark such string to translation.
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from the Gluteal fold, where the Gluteal muscle meets "
        "the top of the back thigh, to the floor.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from the deepest indentation of the back of the ankle "
        "to the floor.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from point where the front leg meets the foot to the "
        "floor.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from the Highhip level, where front abdomen is most "
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from the Neck Back (cervicale vertebra) to the fold at "
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from the fold at the back of the knee to the point "
        "where the front leg meets the top of the foot.",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Height: Neck Back to Waist Side", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from Neck Back to Waist Side. ('Height: Neck Back' - "
        "'Height: Waist Side').",
        "Full measurement description.");
    InitMeasurement(
        heightNeckBackToWaistSide_M, m, g, d, "A22", "(height_neck_back - height_waist_side)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
        "height_waist_back",
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical height from Waist Back to floor.",
...
void VTranslateMeasurements::InitGroupB()
{
    ...
    d = translate(
        "VTranslateMeasurements",
        "Horizontal distance from the greatest abdomen prominence to the greatest "
        "hip prominence.",
        "Full measurement description.");
...
void VTranslateMeasurements::InitGroupC()
{
    ...
    d = translate(
        "VTranslateMeasurements",
        "Horizontal distance between a flat stick, placed to touch Hip and "
        "Scapula, and Waist Back.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Horizontal Distance between a flat stick, placed perpendicular to Heel, "
        "and the greatest indentation of Ankle.",
        "Full measurement description.");
...
void VTranslateMeasurements::InitGroupD()
{
    ...
    d = translate(
        "VTranslateMeasurements",
        "Tuck thumb toward smallest finger, bring fingers close together. Measure "
...
void VTranslateMeasurements::InitGroupF()
{
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from Crown to Neck Back. ('Height: Total' - 'Height: "
        "Neck Back').",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from Chin to Neck Back. ('Height' - 'Height: Neck Back' - 'Head: "
        "Length')",
        "Full measurement description.");
    InitMeasurement(
        headChinToNeckBack_M, m, g, d, "F06", "(height - height_neck_back - head_length)");
    //=================================================================================================================
}
...
void VTranslateMeasurements::InitGroupG()
{
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck circumference, midsection", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements",
        "Circumference at Highbust, following shortest distance between Armfolds "
        "across chest, high under armpits.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Circumference around Waist, following natural contours. Waists are  typically higher in "
        "back.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Bust Side to Bust Side across chest.",
        "Full measurement description.");
    ...
    d = translate("VTranslateMeasurements", "Same as bust_arc_f.", "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Half of 'Highbust arc, front'. From Highbust Front to Highbust Side. ('Highbust arc,  "
        "front' / 2).",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Highbust Side  to Highbust Side across back. ('Highbust "
        "circumference' - 'Highbust arc, front').",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Lowbust Side to Lowbust Side across back.  ('Lowbust circumference' - 'Lowbust arc, "
        "front').",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Highhip Side to Highhip Side across back. ('Highhip circumference' - 'Highhip arc, "
        "front').",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Half of 'Highbust arc, back'. From Highbust Back to Highbust Side. ('Highbust arc, back' "
        "/ 2).",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Half of 'Highhip arc, back'. From Highhip Back to Highbust Side. ('Highhip arc, back'/ "
        "2).",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Hip arc with Abdomen, front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "Curve stiff paper around front of abdomen, tape at sides. Measure from Hip Side to Hip "
        "Side over "
        "paper across front.",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Body circumference at Armfold level", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Body circumference at Bust level", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Body circumference of full torso", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Hip circumference, including Abdomen", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "Measurement at Hip level, including the depth of the Abdomen. (Hip arc, back + Hip arc "
        "with "
        "abdomen, front).",
        "Full measurement description.");
...
void VTranslateMeasurements::InitGroupH()
{
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Front to Waist Front flat", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Tip to Waist Side, front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Waist level, front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Front to Highbust Front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Highbust Front to Waist Front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "From Highbust Front to Waist Front. Use tape to bridge gap between Bustpoints. ('Neck "
        "Front to "
        "Waist Front' - 'Neck Front to Highbust Front').",
        "Full measurement description.");
    InitMeasurement(
        highbustToWaistF_M, m, g, d, "H08", "(neck_front_to_waist_f - neck_front_to_highbust_f)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Bust Front down to Waist level. ('Neck Front to Waist Front' - 'Neck Front to Bust "
        "Front').",
        "Full measurement description.");
    InitMeasurement(
        bustToWaistF_M, m, g, d, "H10", "(neck_front_to_waist_f - neck_front_to_bust_f)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
        "lowbust_to_waist_f",
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Lowbust Front to Waist Front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Tip to Armfold Front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Bust level, front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Highbust level, front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Tip to Waist Side, back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Waist level, back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Highbust Back to Waist Back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "From Highbust Back down to Waist Back. ('Neck Back to Waist Back' - 'Neck Back to "
        "Highbust Back').",
        "Full measurement description.");
    InitMeasurement(
        highbustToWaistB_M, m, g, d, "H22", "(neck_back_to_waist_b - neck_back_to_highbust_b)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
        "neck_back_to_bust_b",
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Bust Back down to Waist level. ('Neck Back to Waist Back' - 'Neck Back to Bust "
        "Back').",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Tip to Armfold Back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Bust level, back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Highbust level, back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Waist Front to Highhip Front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Slope Angle from Neck Side", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "Angle formed by line from Neck Side to Shoulder Tip and line from Neck Side parallel to "
        "floor.",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Slope length from Neck Side", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Slope Angle from Neck Back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "Angle formed by  line from Neck Back to Shoulder Tip and line from Neck Back parallel to "
        "floor.",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Slope length from Neck Back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        ...
        "Full measurement description.");
    InitMeasurement(
        acrossBackToWaistB_M, m, g, d, "H42", "(neck_back_to_waist_b - neck_back_to_across_back)");
    //=================================================================================================================
}
...
void VTranslateMeasurements::InitGroupI()
{
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Tip to Shoulder Tip, front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements",
        "Half of' Shoulder Tip to Shoulder tip, front'. ('Shoulder Tip to Shoulder Tip, front' / "
        "2).",
        "Full measurement description.");
    InitMeasurement(
        shoulderTipToShoulderTipHalfF_M, m, g, d, "I05", "(shoulder_tip_to_shoulder_tip_f/2)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
        "across_chest_half_f",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Tip to Shoulder Tip, back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements",
        "Half of 'Shoulder Tip to Shoulder Tip, back'. ('Shoulder Tip to Shoulder Tip,  back' / "
        "2).",
        "Full measurement description.");
    InitMeasurement(
        shoulderTipToShoulderTipHalfB_M, m, g, d, "I10", "(shoulder_tip_to_shoulder_tip_b/2)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
        "across_back_half_b",
...
void VTranslateMeasurements::InitGroupJ()
{
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Bustpoint to straight down to Waist level, forming a straight line (not curving "
        "along the "
        "body).",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Bustpoint to Bustpoint, half", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Bustpoint, Neck Side to Waist level", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Bustpoint to Bustpoint Halter", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Bustpoint to Shoulder Center", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements", "From Neck Front to Bustpoint.", "Full measurement description.");
...
void VTranslateMeasurements::InitGroupK()
{
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Shoulder Tip to Waist Front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Waist Side, front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements",
        "Mark 1in (2.54cm) outward from Waist Back along Waist level. Measure "
        "from Shoulder Tip diagonal to mark.",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Waist Side, back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Highbust Side, front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Bust Side, front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Highbust Side, back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Neck Side to Bust Side, back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
...
void VTranslateMeasurements::InitGroupL()
{
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Shoulder Tip to Wrist, bent", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Shoulder Tip to Elbow, bent", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements",
        "Elbow tip to wrist. ('Arm: Shoulder Tip to Wrist, bent' - 'Arm: Shoulder Tip to Elbow, "
        "bent').",
        "Full measurement description.");
    InitMeasurement(
        armElbowToWristBent_M,
        m,
        g,
        d,
        "L03",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Elbow circumference, bent", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Elbow to Wrist, arm straight. ('Arm: Shoulder Tip to Wrist' - 'Arm: Shoulder Tip to "
        "Elbow').",
        "Full measurement description.");
    InitMeasurement(
        armElbowToWrist_M,
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Armpit to Wrist, inside", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Armpit to Elbow, inside", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Elbow to Wrist, inside", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "From inside Elbow to Wrist. ('Arm: Armpit to Wrist, inside' - 'Arm: Armpit to Elbow, "
        "inside').",
        "Full measurement description.");
    InitMeasurement(
        armElbowToWristInside_M, m, g, d, "L10", "(arm_armpit_to_wrist - arm_armpit_to_elbow)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
        "arm_upper_circ",
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Upper Arm circumference", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Above Elbow circumference", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Lower Arm circumference", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Shoulder Tip to Armfold line", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        ...
        "Full measurement description.");
    InitMeasurement(
        armNeckSideToWrist_M, m, g, d, "L17", "(shoulder_length + arm_shoulder_tip_to_wrist)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Neck Side to Finger Tip", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "From Neck Side down arm to tip of middle finger. ('Shoulder Length' + 'Arm: Shoulder Tip "
        "to "
        "Wrist' + 'Hand: Length').",
        "Full measurement description.");
    InitMeasurement(
        armNeckSideToFingerTip_M,
        m,
        g,
        d,
        "L18",
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Neck Side over Shoulder Tip down to Elbow. (Shoulder length + "
        "Arm: Shoulder Tip to Elbow).",
        "Full measurement description.");
    InitMeasurement(
        armNeckSideToOuterElbow_M, m, g, d, "L22", "(shoulder_length + arm_shoulder_tip_to_elbow)");
    //=================================================================================================================
}
...
void VTranslateMeasurements::InitGroupM()
{
    ...
    d = translate(
        "VTranslateMeasurements",
        "Stand feet close together. Measure from crotch level (touching body, no extra space) down "
        "to floor.",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Leg: Thigh Upper circumference", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Leg: Thigh Middle circumference", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Leg: Knee Small circumference", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Leg: Ankle High circumference", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Leg: Knee circumference, bent", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Leg: Ankle diagonal circumference", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        ...
        "Full measurement description.");
    InitMeasurement(
        legWaistSideToAnkle_M, m, g, d, "M13", "(leg_waist_side_to_floor - height_ankle)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Waist Side along curve to Hip level then straight down to  Knee level. ('Leg: Waist "
        "Side to "
        "Floor' - 'Height Knee').",
        "Full measurement description.");
    InitMeasurement(
        legWaistSideToKnee_M, m, g, d, "M14", "(leg_waist_side_to_floor - height_knee)");
    //=================================================================================================================
}
...
void VTranslateMeasurements::InitGroupN()
{
    ...
    d = translate(
        "VTranslateMeasurements",
        "Put tape across gap between buttocks at Hip level. Measure from Waist "
        "Front down between legs and up to Waist Back.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Waist Front to start of vagina or end of testicles. ('Crotch length' - 'Crotch "
        "length, back').",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate("VTranslateMeasurements", "Rise length, side, sitting", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    d = translate(
        "VTranslateMeasurements",
        "Measure from Waist Side diagonally to a string tied at the top of the "
        "leg, seated on a hard surface.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from Waist Back to Crotch level. "
        "('Height: Waist Back' - 'Leg: Crotch to Floor')",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical Distance from Waist Front to Crotch level. "
        "('Height: Waist Front' - 'Leg: Crotch to Floor')",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Vertical distance from Waist side down to Crotch level. Use formula "
        "(Height: Waist side - Leg: Crotch to floor).",
        "Full measurement description.");
...
void VTranslateMeasurements::InitGroupO()
{
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Natural Waist circumference", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "Torso circumference at men's natural side Abdominal Obliques "
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Side to Side at Natural Waist level, across the back. Calculate as "
        "( Natural Waist circumference - Natural Waist arc (front) ).",
        "Full measurement description.");
    InitMeasurement(
        waistNaturalArcB_M, m, g, d, "O05", "(waist_natural_circ - waist_natural_arc_f)");
    //=================================================================================================================
    m = translate(
        "VTranslateMeasurements",
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Waist Front to Natural Waist Front", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Waist Back to Natural Waist Back", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Neck Back to Elbow, high bend", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Neck Back to Wrist, high bend", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "Bend Arm with Elbow out, hand in front. Measure from Neck Back to Elbow "
        "Tip to Wrist bone.",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Neck Side to Elbow, high bend", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "Bend Arm with Elbow out, hand in front. Measure from Neck Side to "
        "Elbow Tip.",
        "Full measurement description.");
    ...
    m = translate(
        ...
        "Name in a formula. Don't use math symbols and space in name!!!!");
    g = translate(
        "VTranslateMeasurements", "Arm: Neck Side to Wrist, high bend", "Full measurement name.");
    d = translate(
        "VTranslateMeasurements",
        "Bend Arm with Elbow out, hand in front. Measure from Neck Side to Elbow Tip to Wrist "
        "bone.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Bend Arm with Elbow out, hand in front. Measure from Middle of Back to Elbow Tip to Wrist "
        "bone.",
        "Full measurement description.");
...
void VTranslateMeasurements::InitGroupP()
{
    ...
    d = translate(
        "VTranslateMeasurements",
        "Measure in a curve from Armfold Left Front through Bust Front curved "
        "back up to Armfold Right Front.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "Measure from Armfold Front to Bust Front, shortest distance between the "
        "two, as straight as possible.",
        "Full measurement description.");
    ...
    d = translate(
        "VTranslateMeasurements",
        "From Highbust Back, over Shoulder, then aim at Bustpoint, stopping measurement at "
        "Highbust level.",
        "Full measurement description.");
...
void VTranslateMeasurements::InitGroupQ()
{
    ...
    d = translate(
        "VTranslateMeasurements",
        "This information is pulled from pattern charts in some patternmaking systems, e.g. "
        "Winifred P. "
        "Aldrich's \"Metric Pattern Cutting\".",
        "Full measurement description.");
