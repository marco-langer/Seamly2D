...
public:
    ...
    QVector<QLineF> createNotchLines(
        const VContainer* data, const QVector<QPointF>& seamAllowance = QVector<QPointF>()) const;
...
private:
    ...
    QVector<VSAPoint>
    getNodeSAPoints(const QVector<VPieceNode>& path, int index, const VContainer* data) const;

    bool getNotchSAPoint(
        const QVector<VPieceNode>& path, int index, const VContainer* data, VSAPoint& point) const;
    bool getNotchPreviousSAPoints(
        const QVector<VPieceNode>& path,
        int index,
        const VSAPoint& notchSAPoint,
        const VContainer* data,
        VSAPoint& point) const;
    int getNextNotchSAPoints(
        const QVector<VPieceNode>& path,
        int index,
        const VSAPoint& notchSAPoint,
        const VContainer* data,
        VSAPoint& point) const;
    bool getSeamNotchSAPoint(
    ...
    QVector<QLineF> createSeamAllowanceNotch(
        const QVector<VPieceNode>& path,
    ...
    QVector<QLineF> createBuiltInSaNotch(
        const QVector<VPieceNode>& path,
        const VSAPoint& previousSAPoint,
        const VSAPoint& notchSAPoint,
        const VSAPoint& nextSAPoint,
    ...
    QVector<QLineF>
    createSlitNotch(NotchData notchData, const QVector<QPointF>& seamAllowance) const;
    QVector<QLineF> createTNotch(NotchData notchData, const QVector<QPointF>& pathPoints) const;
    QVector<QLineF>
    createUNotch(const NotchData notchData, const QVector<QPointF>& seamAllowance) const;
    QVector<QLineF>
    createVInternalNotch(NotchData notchData, const QVector<QPointF>& pathPoints) const;
    QVector<QLineF>
    createVExternalNotch(NotchData notchData, const QVector<QPointF>& seamAllowance) const;
    QVector<QLineF>
    createCastleNotch(const NotchData notchData, const QVector<QPointF>& seamAllowance) const;
    QVector<QLineF>
    createDiamondNotch(NotchData notchData, const QVector<QPointF>& seamAllowance) const;
