...
LayoutExportFormat ExportFormatCombobox::getExportFormat() const { return m_currentFormat; }
...
bool ExportFormatCombobox::testPdf()
{
    ...
    if (proc.waitForStarted(15000)
        && (proc.waitForFinished(15000) || proc.state() == QProcess::NotRunning)) {
        res = true;
    } else {
...
QString ExportFormatCombobox::exportFormatDescription(LayoutExportFormat format)
{
    ...
    switch (format) {
    case LayoutExportFormat::SVG: return QString("SVG %1 (*.svg)").arg(filesStr);
    case LayoutExportFormat::PDF: return QString("PDF %1 (*.pdf)").arg(filesStr);
    case LayoutExportFormat::PNG: return QString("PNG %1 (*.png)").arg(filesStr);
    case LayoutExportFormat::JPG: return QString("JPG %1 (*.jpg)").arg(filesStr);
    case LayoutExportFormat::BMP: return QString("BMP %1 (*.bmp)").arg(filesStr);
    case LayoutExportFormat::TIF: return QString("TIF %1 (*.tif)").arg(filesStr);
    case LayoutExportFormat::PPM: return QString("PPM %1 (*.ppm)").arg(filesStr);
    case LayoutExportFormat::OBJ: return "Wavefront OBJ (*.obj)";
    case LayoutExportFormat::PS: return QString("PS %1 (*.ps)").arg(filesStr);
    case LayoutExportFormat::EPS: return QString("EPS %1 (*.eps)").arg(filesStr);
    ...
    case LayoutExportFormat::PDFTiled: return QString("PDF tiled %1 (*.pdf)").arg(filesStr);
