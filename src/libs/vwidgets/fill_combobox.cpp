...
void PieceFillComboBox::init()
{
    ...
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::SolidPattern)), tr("Solid"), FillSolid);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::Dense1Pattern)),
        tr("Density 1"),
        FillDense1);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::Dense2Pattern)),
        tr("Density 2"),
        FillDense2);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::Dense3Pattern)),
        tr("Density 3"),
        FillDense3);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::Dense4Pattern)),
        tr("Density 4"),
        FillDense4);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::Dense5Pattern)),
        tr("Density 5"),
        FillDense5);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::Dense6Pattern)),
        tr("Density 6"),
        FillDense6);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::Dense7Pattern)),
        tr("Density 7"),
        FillDense7);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::HorPattern)),
        tr("Horizontal Line"),
        FillHorizLines);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::VerPattern)),
        tr("Vertical Line"),
        FillVertLines);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::CrossPattern)), tr("Cross"), FillCross);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::BDiagPattern)),
        tr("Backward Diagonal"),
        FillBackwardDiagonal);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::FDiagPattern)),
        tr("Forward Diagonal"),
        FillForwardDiagonal);
    addItem(
        QIcon(createFillIcon(m_iconWidth, m_iconHeight, Qt::DiagCrossPattern)),
        tr("Diagonal Cross"),
        FilldDiagonalCross);
...
QString PieceFillComboBox::getFill() const { return m_currentFill; }
