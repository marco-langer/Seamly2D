...
void PageFormatCombobox::init()
{
    ...
    connect(
        ...
        this,
        &PageFormatCombobox::updatePageFormat);

    updatePageFormat(currentIndex());
}

PaperSizeFormat PageFormatCombobox::getPageFormat() const { return m_currentFormat; }
...
{
    switch (format) {
    case PaperSizeFormat::A0: return QString("A0");
    case PaperSizeFormat::A1: return QString("A1");
    case PaperSizeFormat::A2: return QString("A2");
    case PaperSizeFormat::A3: return QString("A3");
    case PaperSizeFormat::A4: return QString("A4");
    case PaperSizeFormat::Letter: return QString("Letter");
    case PaperSizeFormat::Legal: return QString("Legal");
    case PaperSizeFormat::Tabloid: return QString("Tabloid");
    case PaperSizeFormat::AnsiC: return QString("ANSI C");
    case PaperSizeFormat::AnsiD: return QString("ANSI D");
    case PaperSizeFormat::AnsiE: return QString("ANSI E");
    case PaperSizeFormat::Roll24in: return QString("Roll 24in");
    case PaperSizeFormat::Roll30in: return QString("Roll 30in");
    case PaperSizeFormat::Roll36in: return QString("Roll 36in");
