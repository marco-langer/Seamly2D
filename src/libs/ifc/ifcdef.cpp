...
{
    const QStringList lineTypes = QStringList()
                               << LineTypeNone << LineTypeSolidLine << LineTypeDashLine
                               << LineTypeDotLine << LineTypeDashDotLine << LineTypeDashDotDotLine;
    return lineTypes;
}
...
QString PenStyleToLineType(Qt::PenStyle penStyle)
{
    ...
    case Qt::DotLine: return LineTypeDotLine;
    case Qt::DashDotLine: return LineTypeDashDotLine;
...
QMap<QString, QString> lineTypeList()
{
    ...
    for (int i = 0; i < lineTypeNames.size(); ++i) {
        ...
        case 5:   // LineTypeDashDotDotLine
            ...
            break;
        case 0:   // LineTypeNone
        default: name = QObject::tr("No Pen"); break;
        }
...
QMap<QString, QString> lineWeightList()
{
    ...
    const QStringList lineWeights = QStringList() << "0"
                                                  << "0.05"
                                                  << "0.09"
                                                  << "0.13"
                                                  << "0.15"
    ...
    for (int i = 0; i < lineWeights.size(); ++i) {
        QString name;
        switch (i) {
        case 1: name = "0.05mm"; break;
        case 2: name = "0.09"; break;
        case 3: name = "0.13mm (ISO)"; break;
        case 4: name = "0.15mm"; break;
        case 5: name = "0.18mm (ISO)"; break;
        case 6: name = "0.20mm"; break;
        case 7: name = "0.25mm (ISO)"; break;
        case 8: name = "0.30mm"; break;
        case 9: name = "0.35mm (ISO)"; break;
        case 10: name = "0.40mm"; break;
        case 11: name = "0.50mm (ISO)"; break;
        case 12: name = "0.53mm"; break;
        case 13: name = "0.60mm"; break;
        case 14: name = "0.70mm (ISO)"; break;
        case 15: name = "0.80mm"; break;
        case 16: name = "0.90mm"; break;
        case 17: name = "1.00mm (ISO)"; break;
        case 18: name = "1.06mm"; break;
        case 19: name = "1.20mm"; break;
        case 20: name = "1.40mm (ISO)"; break;
        case 21: name = "1.58mm"; break;
        case 22: name = "2.00mm (ISO)"; break;
        case 23: name = "2.11mm"; break;
        case 0:
        default: name = "0.00mm"; break;
        }
...
const QStringList builInVariables =
    QStringList() << measurement_ << variable_ << line_ << angleLine_ << arc_ << elarc_ << spl_
                  << splPath << radiusArc_ << radius1ElArc_ << radius2ElArc_ << angle1Arc_
                  << angle2Arc_ << angle1ElArc_ << angle2ElArc_ << angle1Spl_ << angle2Spl_
                  << angle1SplPath << angle2SplPath << seg_ << currentLength << currentSeamAllowance
                  << c1LengthSpl_ << c2LengthSpl_ << c1LengthSplPath << c2LengthSplPath;
