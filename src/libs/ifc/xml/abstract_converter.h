...
protected:
    ...
    void
    Replace(QString& formula, const QString& newName, int position, const QString& token, int& bias)
        const;
...
private:
    ...
    /** \brief Removes single or repeated '.bak' extension (as long as it is at the end of \arg
     * fileName) */
