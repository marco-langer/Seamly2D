...
// todo: this way, this class doesn't really make sense. What we have to do is pass a widget factory
// instead of the actual widget!

//! This property holds a QWidget and displays it, if the view supports that. If not, it will behave
//! like an empty property
