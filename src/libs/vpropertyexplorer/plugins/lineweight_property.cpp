...
QWidget* VPE::LineWeightProperty::createEditor(
    QWidget* parent, const QStyleOptionViewItem& options, const QAbstractItemDelegate* delegate)
{
    ...
    connect(
        ...
        this,
        &LineWeightProperty::currentIndexChanged);
...
QMap<QString, QString> VPE::LineWeightProperty::getLineWeights() const { return m_lineWeights; }
...
QString VPE::LineWeightProperty::type() const { return QStringLiteral("lineWeight"); }

VPE::VProperty* VPE::LineWeightProperty::clone(bool include_children, VProperty* container) const
{
    return VProperty::clone(
        include_children, container ? container : new LineWeightProperty(getName()));
}

int VPE::LineWeightProperty::indexOfLineWeight(
    const QMap<QString, QString>& lineWeights, const QString& weight)
{
