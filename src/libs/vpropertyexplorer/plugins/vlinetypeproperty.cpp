...
QWidget* VPE::LineTypeProperty::createEditor(
...
QMap<QString, QString> VPE::LineTypeProperty::getLineTypes() const { return m_lineTypes; }
...
QString VPE::LineTypeProperty::type() const { return QStringLiteral("lineType"); }

VPE::VProperty* VPE::LineTypeProperty::clone(bool include_children, VProperty* container) const
{
    return VProperty::clone(
        include_children, container ? container : new LineTypeProperty(getName()));
}

int VPE::LineTypeProperty::indexOfLineType(
    const QMap<QString, QString>& lineTypes, const QString& lineType)
{
