...
QWidget* VPE::VObjectProperty::createEditor(
...
// cppcheck-suppress unusedFunction
QMap<QString, quint32> VPE::VObjectProperty::getObjects() const { return m_objects; }
...
QString VPE::VObjectProperty::type() const { return "objectList"; }

VPE::VProperty* VPE::VObjectProperty::clone(bool include_children, VProperty* container) const
{
    return VProperty::clone(
        include_children, container ? container : new VObjectProperty(getName()));
}

int VPE::VObjectProperty::indexOfObject(
    const QMap<QString, quint32>& objects, const QString& object)
{
