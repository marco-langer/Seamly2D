...
QString VPE::VProperty::type() const { return "string"; }
...
bool VPE::VProperty::paint(
    QPainter*, const QStyleOptionViewItem&, const QModelIndex&, const QAbstractItemDelegate*) const
{
    return false;
}

//! Returns an editor widget, or NULL if it doesn't supply one
QWidget* VPE::VProperty::createEditor(
    QWidget* parent, const QStyleOptionViewItem&, const QAbstractItemDelegate*)
{
...
QVariant VPE::VProperty::getValue() const { return d_ptr->VariantValue; }

// cppcheck-suppress unusedFunction
QString VPE::VProperty::serialize() const { return getValue().toString(); }

void VPE::VProperty::deserialize(const QString& value) { setValue(QVariant(value)); }


void VPE::VProperty::setName(const QString& name) { d_ptr->Name = name; }


QString VPE::VProperty::getName() const { return d_ptr->Name; }


void VPE::VProperty::setDescription(const QString& desc) { d_ptr->Description = desc; }


QString VPE::VProperty::getDescription() const { return d_ptr->Description; }

//! Returns a reference to the list of children
QList<VPE::VProperty*>& VPE::VProperty::getChildren() { return d_ptr->Children; }

//! Returns a reference to the list of children
const QList<VPE::VProperty*>& VPE::VProperty::getChildren() const { return d_ptr->Children; }
...
int VPE::VProperty::getRowCount() const { return d_ptr->Children.count(); }

//! Gets the parent of this property
VPE::VProperty* VPE::VProperty::getParent() const { return d_ptr->Parent; }
...
int VPE::VProperty::getChildRow(VProperty* child) const { return d_ptr->Children.indexOf(child); }

//! Returns whether the views have to update the parent of this property if it changes
bool VPE::VProperty::getUpdateParent() const { return d_ptr->updateParent; }

//! Returns whether the views have to update the children of this property if it changes
bool VPE::VProperty::getUpdateChildren() const { return d_ptr->UpdateChildren; }
...
QStringList VPE::VProperty::getSettingKeys() const { return QStringList(); }
...
VPE::Property VPE::VProperty::propertyType() const { return d_ptr->type; }

void VPE::VProperty::setPropertyType(const Property& type) { d_ptr->type = type; }

void VPE::VProperty::updateParent(const QVariant& value) { Q_UNUSED(value) }
