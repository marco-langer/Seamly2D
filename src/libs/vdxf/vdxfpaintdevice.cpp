...
QPaintEngine* VDxfPaintDevice::paintEngine() const { return engine; }
...
//---------------------------------------------------------------------------------------------------------------------
double VDxfPaintDevice::getResolution() const { return engine->getResolution(); }
...
//---------------------------------------------------------------------------------------------------------------------
DRW::Version VDxfPaintDevice::GetVersion() const { return engine->GetVersion(); }
...
void VDxfPaintDevice::SetBinaryFormat(bool binary)
{
    if (engine->isActive()) {
        qWarning(
            "VDxfPaintDevice::SetBinaryFormat(), cannot set binary format while Dxf is being "
            "generated");
        return;
    }
...
//---------------------------------------------------------------------------------------------------------------------
bool VDxfPaintDevice::IsBinaryFormat() const { return engine->IsBinaryFormat(); }
...
void VDxfPaintDevice::setMeasurement(const VarMeasurement& var)
{
    if (engine->isActive()) {
        qWarning(
            "VDxfPaintDevice::setMeasurement(), cannot set measurements while Dxf is being "
            "generated");
        return;
    }
