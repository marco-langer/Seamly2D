...
dxfRW::dxfRW(const char* name)
    ...
    , writingBlock()
    , elParts(128)
    ,   // parts munber when convert ellipse to polyline
    blockMap()
    , imageDef()
    , currHandle()
{
...
{
    switch (lvl) {
    case DRW::DEBUG: DRW_DBGSL(DRW_dbg::DEBUG); break;
    default: DRW_DBGSL(DRW_dbg::NONE);
    }
}
...
bool dxfRW::writePolyline(DRW_Polyline* ent)
{
    ...
    if (not qFuzzyIsNull(crd.x) || not qFuzzyIsNull(crd.y)
        || not DRW_FuzzyComparePossibleNulls(crd.z, 1)) {
            ...
            if ((loop->type & 2) == 2) {
                ...
                for (int j = 0; j < loop->numedges; ++j) {
                    ...
                    case DRW::LINE: {
                        ...
                        DRW_Line* l =
                            static_cast<DRW_Line*>(loop->objlist.at(static_cast<size_t>(j)));
                    ...
                    case DRW::ARC: {
                        ...
                        DRW_Arc* a =
                            static_cast<DRW_Arc*>(loop->objlist.at(static_cast<size_t>(j)));
                    ...
                    case DRW::ELLIPSE: {
                        ...
                        DRW_Ellipse* a =
                            static_cast<DRW_Ellipse*>(loop->objlist.at(static_cast<size_t>(j)));
                        a->correctAxis();
                        writer->writeDouble(10, a->basePoint.x);
                        writer->writeDouble(20, a->basePoint.y);
...
bool dxfRW::processBlock()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: block.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processEllipse()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: ellipse.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processTrace()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: trace.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processSolid()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: solid.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::process3dface()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: face.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processViewport()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: vp.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processPoint()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: point.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processLine()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: line.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processCircle()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: circle.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processArc()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: arc.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processInsert()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: insert.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processLWPolyline()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: pl.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processVertex(DRW_Polyline* pl)
{
    ...
    while (reader->readRec(&code)) {
        ...
        case 0: {
            ...
            DRW_FALLTHROUGH
        default: v->parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processText()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: txt.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processHatch()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: hatch.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processSpline()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: sp.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processImage()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: img.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processDimension()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: dim.parseCode(code, reader); break;
        }
    }
    return true;
}
...
bool dxfRW::processLeader()
{
    ...
    while (reader->readRec(&code)) {
        ...
        default: leader.parseCode(code, reader); break;
        }
    }
    return true;
}
