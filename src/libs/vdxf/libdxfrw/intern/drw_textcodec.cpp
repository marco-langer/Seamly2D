...
void DRW_TextCodec::setVersion(int v, bool dxfFormat)
{
    ...
    } else if (v == DRW::AC1012 || v == DRW::AC1014 || v == DRW::AC1015 || v == DRW::AC1018) {
        version = DRW::AC1015;
...
void DRW_TextCodec::setVersion(std::string* v, bool dxfFormat)
{
    ...
    if (versionStr == "AC1009" || versionStr == "AC1006") {
        ...
        versionStr == "AC1012" || versionStr == "AC1014" || versionStr == "AC1015"
        || versionStr == "AC1018") {
...
void DRW_TextCodec::setCodePage(const std::string* c, bool dxfFormat)
{
    ...
    if (version < DRW::AC1021) {
        if (cp == "UTF-8") {   // DXF older than 2007 are write in win codepages
            cp = "ANSI_1252";
        }
...
std::string DRW_TextCodec::correctCodePage(const std::string& s)
{
    ...
    if (cp == "ANSI_874" || cp == "CP874" || cp == "ISO8859-11" || cp == "TIS-620") {
        ...
        cp == "ANSI_1251" || cp == "CP1251" || cp == "ISO8859-5" || cp == "KOI8-R" || cp == "KOI8-U"
        || cp == "IBM 866") {
        return "ANSI_1251";
        // Western Europe
    } else if (
        cp == "ANSI_1252" || cp == "CP1252" || cp == "LATIN1" || cp == "ISO-8859-1" || cp == "CP819"
        || cp == "CSISO" || cp == "IBM819" || cp == "ISO_8859-1" || cp == "APPLE ROMAN"
        || cp == "ISO8859-1" || cp == "ISO8859-15" || cp == "ISO-IR-100" || cp == "L1"
        || cp == "IBM 850") {
        return "ANSI_1252";
        // Greek
        ...
        cp == "ANSI_1257" || cp == "CP1257" || cp == "ISO8859-4" || cp == "ISO8859-10"
        || cp == "ISO8859-13") {
        return "ANSI_1257";
        // Vietnamese
        ...
        cp == "ANSI_932" || cp == "SHIFT-JIS" || cp == "SHIFT_JIS" || cp == "CSSHIFTJIS"
        ...
        cp == "ANSI_936" || cp == "GBK" || cp == "GB2312" || cp == "CHINESE" || cp == "CN-GB"
        || cp == "CSGB2312" || cp == "CSGB231280" || cp == "CSISO58BG231280" || cp == "GB_2312-80"
        || cp == "GB231280" || cp == "GB2312-80" || cp == "ISO-IR-58" || cp == "GB18030") {
        return "ANSI_936";
        // Korean
        ...
        cp == "ANSI_950" || cp == "BIG5" || cp == "CN-BIG5" || cp == "CSBIG5" || cp == "X-X-BIG5"
        || cp == "BIG5-HKSCS") {
        return "ANSI_950";
