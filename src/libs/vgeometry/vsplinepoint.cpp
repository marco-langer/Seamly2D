 ...
 * @param value point.
 */
void VFSplinePoint::SetP(const VPointF& value) { d->pSpline = value; }
 ...
 * @return angle.
 */
qreal VFSplinePoint::Angle1() const { return d->angle1; }
 ...
 * @return angle.
 */
qreal VFSplinePoint::Angle2() const { return d->angle2; }
 ...
 * @return coefficient.
 */
qreal VFSplinePoint::KAsm1() const { return d->kAsm1; }
 ...
 */
void VFSplinePoint::SetKAsm1(const qreal& value) { d->kAsm1 = value; }
 ...
 * @return coefficient.
 */
qreal VFSplinePoint::KAsm2() const { return d->kAsm2; }
