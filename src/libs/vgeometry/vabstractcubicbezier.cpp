 ...
 * @return point of cutting. This point is forth point of first spline and first point of second
 * spline.
 */
 ...
 */
void VAbstractCubicBezier::PointBezier_r(
    qreal x1,
    qreal y1,
    qreal x2,
    qreal y2,
    ...
    QVector<qreal>& py)
{
    ...
    //----------------------
    PointBezier_r(
        x1, y1, x12, y12, x123, y123, x1234, y1234, static_cast<qint16>(level + 1), px, py);
    PointBezier_r(
        x1234, y1234, x234, y234, x34, y34, x4, y4, static_cast<qint16>(level + 1), px, py);
}
 ...
 */
QVector<QPointF> VAbstractCubicBezier::GetCubicBezierPoints(
    const QPointF& p1, const QPointF& p2, const QPointF& p3, const QPointF& p4)
{
    ...
    x.append(p1.x());
    y.append(p1.y());
    PointBezier_r(p1.x(), p1.y(), p2.x(), p2.y(), p3.x(), p3.y(), p4.x(), p4.y(), 0, wx, wy);
    x.append(p4.x());
    y.append(p4.y());
 ...
 * @return length.
 */
qreal VAbstractCubicBezier::LengthBezier(
    const QPointF& p1, const QPointF& p2, const QPointF& p3, const QPointF& p4)
{
