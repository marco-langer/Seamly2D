    ...
    if (size > 0) {
        ...
        for (int i = 0; i < size; ++i) {
            VScaledEllipse* point =
                this->getPoint(mainPoints, static_cast<unsigned>(i), 1 /*zValue*/);
        ...
        if (countSubSpl >= 1) {
            ...
            for (qint32 i = 1; i <= countSubSpl; ++i) {
                ...
                DrawLine(
                    ctrlLine1,
                    QLineF(static_cast<QPointF>(spl.GetP1()), static_cast<QPointF>(spl.GetP2())),
                    mainColor,
                    lineWeight,
                    Qt::DashLine);

                VScaledEllipse* p2 =
                    this->getPoint(ctrlPoints, static_cast<unsigned>(preLastPoint));
                DrawPoint(p2, static_cast<QPointF>(spl.GetP2()), Qt::green);

                VScaledLine* ctrlLine2 = this->getLine(static_cast<unsigned>(lastPoint));
                DrawLine(
                    ctrlLine2,
                    QLineF(static_cast<QPointF>(spl.GetP4()), static_cast<QPointF>(spl.GetP3())),
                    mainColor,
                    lineWeight,
                    Qt::DashLine);
...
//---------------------------------------------------------------------------------------------------------------------
VScaledEllipse*
VisToolCubicBezierPath::getPoint(QVector<VScaledEllipse*>& points, quint32 i, qreal z)
{
...
void VisToolCubicBezierPath::Creating(const QVector<VPointF>& pathPoints, int pointsLeft)
{
    ...
    case 0: {
        ...
        if (pathPoints.size() >= 4) {
            ...
            DrawLine(helpLine1, p1p2, mainColor, lineWeight, Qt::DashLine);
            ...
            DrawLine(
                helpLine1,
                QLineF(static_cast<QPointF>(p1), Visualization::scenePos),
                mainColor,
                lineWeight,
                Qt::DashLine);
        }
    ...
    case 1: {
        ...
        if (subSplCount >= 1) {
            ...
            QLineF prP3p1(
                static_cast<QPointF>(pathPoints.at(subSplPoints + pointsLeft - 2)),
        ...
        DrawLine(
            helpLine1, QLineF(static_cast<QPointF>(p1), p2), mainColor, lineWeight, Qt::DashLine);
    ...
    case 2: {
        ...
        if (subSplCount >= 1) {
            QLineF p1p2(static_cast<QPointF>(p1), p2);
            QLineF prP3p1(
                static_cast<QPointF>(pathPoints.at(subSplPoints + pointsLeft - 3)),
                static_cast<QPointF>(p1));
            p1p2.setAngle(prP3p1.angle());
            p2 = p1p2.p2();
        }
        ...
        DrawLine(
            helpLine1, QLineF(static_cast<QPointF>(p1), p2), mainColor, lineWeight, Qt::DashLine);
        DrawLine(
            helpLine2, QLineF(p3, Visualization::scenePos), mainColor, lineWeight, Qt::DashLine);
    ...
    if (size > 0) {
        ...
        if (size < 7) {
            ...
            Visualization::toolTip =
                tr("<b>Curved path</b>: select seven or more points, "
                   "Press <b>ENTER</b> to finish tool creation");
        } else {
            Visualization::toolTip =
                tr("<b>Curved path</b>: select more points for complete segment");
        }
