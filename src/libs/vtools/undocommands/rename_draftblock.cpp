...
RenameDraftBlock::RenameDraftBlock(
    VAbstractPattern* doc, const QString& newBlockName, QComboBox* combo, QUndoCommand* parent)
...
//---------------------------------------------------------------------------------------------------------------------
int RenameDraftBlock::id() const { return static_cast<int>(UndoCommand::RenameDraftBlock); }
