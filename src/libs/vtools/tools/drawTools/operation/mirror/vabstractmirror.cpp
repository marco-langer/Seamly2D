        ...
        for (int i = 0; i < source.size(); ++i) {
            ...
            case GOType::SplinePath:
                dest.append(createCurveWithSegments<VSplinePath>(
                    id, objectId, fPoint, sPoint, suffix, data));
                break;
        ...
        for (int i = 0; i < source.size(); ++i) {
            ...
            case GOType::EllipticalArc:
                updateArc<VEllipticalArc>(
                    id, objectId, fPoint, sPoint, suffix, data, dest.at(i).id);
                break;
            case GOType::Spline:
...
//---------------------------------------------------------------------------------------------------------------------
DestinationItem VAbstractMirror::createPoint(
    quint32 idTool,
    quint32 idItem,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
DestinationItem VAbstractMirror::createArc(
    quint32 idTool,
    quint32 idItem,
    const QPointF& firstPoint,
    const QPointF& secondPoint,
...
//---------------------------------------------------------------------------------------------------------------------
void VAbstractMirror::updatePoint(
    quint32 idTool,
    quint32 idItem,
    const QPointF& firstPoint,
    const QPointF& secondPoint,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
void VAbstractMirror::updateArc(
    quint32 idTool,
    quint32 idItem,
    const QPointF& firstPoint,
    const QPointF& secondPoint,
