    ...
    if (typeCreation == Source::FromGui) {
        ...
        for (int i = 0; i < source.size(); ++i) {
            ...
            case GOType::Arc:
                ...
                break;
            case GOType::EllipticalArc:
                dest.append(createArc<VEllipticalArc>(
                    id,
                    item.id,
                    calcAngle,
                    calcLength,
            ...
            case GOType::Spline:
                ...
                qCDebug(vTool, "angle:  %f", calcAngle);
                qCDebug(vTool, "rotation:  %f\n", calcRotation);
                dest.append(createCurve<VSpline>(
                    id,
                    item.id,
                    calcAngle,
                    calcLength,
                ...
                break;
            case GOType::SplinePath:
                dest.append(createCurveWithSegments<VSplinePath>(
                    id,
                    item.id,
                    calcAngle,
                    calcLength,
                ...
                break;
            case GOType::CubicBezier:
                dest.append(createCurve<VCubicBezier>(
                    id,
                    item.id,
                    calcAngle,
                    calcLength,
            ...
            case GOType::CubicBezierPath:
                ...
                qCDebug(vTool, "angle:  %f", calcAngle);
                qCDebug(vTool, "rotation:  %f\n", calcRotation);
                dest.append(createCurveWithSegments<VCubicBezierPath>(
                    id,
                    item.id,
                    calcAngle,
                    calcLength,
        ...
        for (int i = 0; i < source.size(); ++i) {
            ...
            case GOType::Spline:
                ...
                break;
            case GOType::SplinePath:
                updateCurveWithSegments<VSplinePath>(
                    id,
                    item.id,
                    calcAngle,
                    calcLength,
            ...
            case GOType::CubicBezier:
                ...
                break;
            case GOType::CubicBezierPath:
                updateCurveWithSegments<VCubicBezierPath>(
                    id,
                    item.id,
                    calcAngle,
                    calcLength,
...
//---------------------------------------------------------------------------------------------------------------------
quint32 VToolMove::getOriginPointId() const { return m_originPointId; }
...
//---------------------------------------------------------------------------------------------------------------------
void VToolMove::ShowVisualization(bool show) { ShowToolVisualization<VisToolMove>(show); }
...
void VToolMove::SetVisualization()
{
    if (!vis.isNull()) {
        ...
        visual->SetAngle(qApp->translateVariables()->FormulaToUser(
        ...
        visual->setRotation(qApp->translateVariables()->FormulaToUser(
            formulaRotation, qApp->Settings()->getOsSeparator()));
...
//---------------------------------------------------------------------------------------------------------------------
DestinationItem VToolMove::createPoint(
    quint32 idTool,
    quint32 idItem,
    qreal angle,
    qreal length,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
DestinationItem VToolMove::createItem(
    quint32 idTool,
    quint32 idItem,
    qreal angle,
    qreal length,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
DestinationItem VToolMove::createArc(
    quint32 idTool,
    quint32 idItem,
    qreal angle,
    qreal length,
    ...
    VContainer* data)
{
    const DestinationItem item =
        createItem<Item>(idTool, idItem, angle, length, rotation, rotationOrigin, suffix, data);
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
DestinationItem VToolMove::createCurveWithSegments(
    quint32 idTool,
    quint32 idItem,
    qreal angle,
    qreal length,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
void VToolMove::updateCurveWithSegments(
    quint32 idTool,
    quint32 idItem,
    qreal angle,
    qreal length,
