...
//---------------------------------------------------------------------------------------------------------------------
VToolRotation* VToolRotation::Create(
    ...
    VContainer* data)
{
    ...
    VToolRotation* operation = Create(
        0,
        originPointId,
        angle,
        suffix,
    ...
    const Source& typeCreation)
{
    ...
    if (typeCreation == Source::FromGui) {
        ...
        for (int i = 0; i < source.size(); ++i) {
            ...
            case GOType::EllipticalArc:
                dest.append(
                    createArc<VEllipticalArc>(id, objectId, oPoint, calcAngle, suffix, data));
                break;
            case GOType::Spline:
            ...
            case GOType::SplinePath:
                dest.append(createCurveWithSegments<VSplinePath>(
                    id, objectId, oPoint, calcAngle, suffix, data));
                break;
            case GOType::CubicBezier:
                dest.append(
                    createCurve<VCubicBezier>(id, objectId, oPoint, calcAngle, suffix, data));
                break;
        ...
        for (int i = 0; i < source.size(); ++i) {
            ...
            case GOType::EllipticalArc:
                updateArc<VEllipticalArc>(
                    id, objectId, oPoint, calcAngle, suffix, data, dest.at(i).id);
                break;
            case GOType::Spline:
    ...
    if (parse == Document::FullParse) {
        ...
        VToolRotation* tool =
            new VToolRotation(doc, data, id, origin, angle, suffix, source, dest, typeCreation);
        scene->addItem(tool);
...
//---------------------------------------------------------------------------------------------------------------------
quint32 VToolRotation::getOriginPointId() const { return m_originPointId; }
...
//---------------------------------------------------------------------------------------------------------------------
void VToolRotation::ShowVisualization(bool show) { ShowToolVisualization<VisToolRotation>(show); }
...
//---------------------------------------------------------------------------------------------------------------------
DestinationItem VToolRotation::createPoint(
    quint32 idTool,
    quint32 idItem,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
DestinationItem VToolRotation::createItem(
    quint32 idTool,
    quint32 idItem,
    const QPointF& origin,
    qreal angle,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
DestinationItem VToolRotation::createArc(
    quint32 idTool,
    quint32 idItem,
    const QPointF& origin,
    qreal angle,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
DestinationItem VToolRotation::createCurveWithSegments(
    quint32 idTool,
    quint32 idItem,
    const QPointF& origin,
    qreal angle,
...
//---------------------------------------------------------------------------------------------------------------------
void VToolRotation::updatePoint(
    quint32 idTool,
    quint32 idItem,
    const QPointF& origin,
    qreal angle,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
void VToolRotation::updateCurve(
    quint32 idTool,
    quint32 idItem,
    const QPointF& origin,
    qreal angle,
...
//---------------------------------------------------------------------------------------------------------------------
template <class Item>
void VToolRotation::updateCurveWithSegments(
    quint32 idTool,
    quint32 idItem,
    const QPointF& origin,
    qreal angle,
