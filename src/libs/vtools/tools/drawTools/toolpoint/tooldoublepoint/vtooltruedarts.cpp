...
void VToolTrueDarts::setDialog()
{
    ...
    const auto& p1{ *VAbstractTool::data.GeometricObject<VPointF>(p1id) };
    const auto& p2{ *VAbstractTool::data.GeometricObject<VPointF>(p2id) };
...
//---------------------------------------------------------------------------------------------------------------------
VToolTrueDarts* VToolTrueDarts::Create(
...
VToolTrueDarts* VToolTrueDarts::Create(
    ...
    const Source& typeCreation)
{
    const auto& baseLineP1{ *data->GeometricObject<VPointF>(baseLineP1Id) };
    const auto& baseLineP2{ *data->GeometricObject<VPointF>(baseLineP2Id) };
    const auto& dartP1{ *data->GeometricObject<VPointF>(dartP1Id) };
    const auto& dartP2{ *data->GeometricObject<VPointF>(dartP2Id) };
    const auto& dartP3{ *data->GeometricObject<VPointF>(dartP3Id) };

    QPointF fPoint1;
    QPointF fPoint2;
    VToolTrueDarts::FindPoint(
        static_cast<QPointF>(baseLineP1),
        static_cast<QPointF>(baseLineP2),
        static_cast<QPointF>(dartP1),
        static_cast<QPointF>(dartP2),
        static_cast<QPointF>(dartP3),
        fPoint1,
        fPoint2);
    ...
    if (parse == Document::FullParse) {
        ...
        VToolTrueDarts* points = new VToolTrueDarts(
            doc,
            data,
            id,
            p1id,
...
//---------------------------------------------------------------------------------------------------------------------
void VToolTrueDarts::ShowVisualization(bool show) { ShowToolVisualization<VisToolTrueDarts>(show); }
...
//---------------------------------------------------------------------------------------------------------------------
quint32 VToolTrueDarts::GetBaseLineP1Id() const { return baseLineP1Id; }
...
//---------------------------------------------------------------------------------------------------------------------
quint32 VToolTrueDarts::GetBaseLineP2Id() const { return baseLineP2Id; }
...
//---------------------------------------------------------------------------------------------------------------------
quint32 VToolTrueDarts::GetDartP1Id() const { return dartP1Id; }
...
//---------------------------------------------------------------------------------------------------------------------
quint32 VToolTrueDarts::GetDartP2Id() const { return dartP2Id; }
...
//---------------------------------------------------------------------------------------------------------------------
quint32 VToolTrueDarts::GetDartP3Id() const { return dartP3Id; }
...
void VToolTrueDarts::SaveDialog(QDomElement& domElement)
{
    ...
    doc->SetAttribute(
        domElement, AttrBaseLineP1, QString().setNum(dialogTool->GetFirstBasePointId()));
    doc->SetAttribute(
        domElement, AttrBaseLineP2, QString().setNum(dialogTool->GetSecondBasePointId()));
...
//---------------------------------------------------------------------------------------------------------------------
void VToolTrueDarts::SaveOptions(QDomElement& tag, const VGObject* obj)
{
