 ...
 *
 * When math parser find in formula error user can try fix issue. Dialog will show all variables
 * that user can use in this formula. Dialog check fixed variant of formula.
 *
