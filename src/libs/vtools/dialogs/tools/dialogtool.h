...
protected:
    ...
    /** @brief prepare show if we prepare. Show dialog after finish working with visual part of
     * tool*/
    bool prepare;
    ...
    void
    DeployFormula(QPlainTextEdit* formula, QPushButton* buttonGrowLength, int formulaBaseHeight);
...
//---------------------------------------------------------------------------------------------------------------------
inline VAbstractTool* DialogTool::GetAssociatedTool() { return this->associatedTool; }
...
inline T DialogTool::getCurrentCrossPoint(QComboBox* box) const
{
    ...
    switch (value) {
    case 1:
    case 2: return static_cast<T>(value);
    default: return static_cast<T>(1);
    }
}
