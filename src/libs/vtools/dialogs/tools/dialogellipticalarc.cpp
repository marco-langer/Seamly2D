    ...
    , newDuplicate(-1)
{
    ...
    connect(
        ui->toolButtonExprRadius1, &QPushButton::clicked, this, &DialogEllipticalArc::FXRadius1);
    connect(
        ui->toolButtonExprRadius2, &QPushButton::clicked, this, &DialogEllipticalArc::FXRadius2);
    ...
    connect(
        ui->toolButtonExprRotationAngle,
        &QPushButton::clicked,
        this,
        &DialogEllipticalArc::FXRotationAngle);

    connect(
        ui->plainTextEditRadius1,
        &QPlainTextEdit::textChanged,
        this,
        &DialogEllipticalArc::Radius1Changed);
    connect(
        ui->plainTextEditRadius2,
        &QPlainTextEdit::textChanged,
        this,
        &DialogEllipticalArc::Radius2Changed);
    connect(
        ui->plainTextEditF1, &QPlainTextEdit::textChanged, this, &DialogEllipticalArc::F1Changed);
    connect(
        ui->plainTextEditF2, &QPlainTextEdit::textChanged, this, &DialogEllipticalArc::F2Changed);
    connect(
        ui->plainTextEditRotationAngle,
        &QPlainTextEdit::textChanged,
        this,
        &DialogEllipticalArc::RotationAngleChanged);

    connect(
        ui->pushButtonGrowLengthRadius1,
        &QPushButton::clicked,
        this,
        &DialogEllipticalArc::DeployRadius1TextEdit);
    connect(
        ui->pushButtonGrowLengthRadius2,
        &QPushButton::clicked,
        this,
        &DialogEllipticalArc::DeployRadius2TextEdit);
    connect(
        ui->pushButtonGrowLengthF1,
        &QPushButton::clicked,
        this,
        &DialogEllipticalArc::DeployF1TextEdit);
    connect(
        ui->pushButtonGrowLengthF2,
        &QPushButton::clicked,
        this,
        &DialogEllipticalArc::DeployF2TextEdit);
    connect(
    ...
    connect(
        ui->centerPoint_ComboBox,
        &QComboBox::currentTextChanged,
        this,
        &DialogEllipticalArc::pointNameChanged);
...
QString DialogEllipticalArc::GetRadius1() const
{
    return qApp->translateVariables()->TryFormulaFromUser(
        radius1, qApp->Settings()->getOsSeparator());
}
...
{
    return qApp->translateVariables()->TryFormulaFromUser(
        radius2, qApp->Settings()->getOsSeparator());
}
...
{
    return qApp->translateVariables()->TryFormulaFromUser(
        rotationAngle, qApp->Settings()->getOsSeparator());
}
...
void DialogEllipticalArc::EvalRadiuses()
{
    ...
    const qreal radius_1 =
        Eval(ui->plainTextEditRadius1->toPlainText(), flagRadius1, ui->labelResultRadius1, postfix);
    ...
    const qreal radius_2 =
        Eval(ui->plainTextEditRadius2->toPlainText(), flagRadius2, ui->labelResultRadius2, postfix);
    if (radius_2 < 0) {
        flagRadius2 = false;
        ChangeColor(labelEditFormula, Qt::red);
...
void DialogEllipticalArc::EvalAngles()
{
    ...
    angleRotation = Eval(
        ui->plainTextEditRotationAngle->toPlainText(),
        flagRotationAngle,
        ui->labelResultRotationAngle,
        degreeSymbol,
        false);
...
//---------------------------------------------------------------------------------------------------------------------
/**
 * @brief RotationAngleChanged after change formula of rotation angle calculate value and show
 * result
 */
void DialogEllipticalArc::RotationAngleChanged()
{
    ...
    labelResultCalculation = ui->labelResultF2;
    ValFormulaChanged(
        flagRotationAngle, ui->plainTextEditRotationAngle, timerRotationAngle, degreeSymbol);
}
...
{
    DeployFormula(
        ui->plainTextEditRadius1, ui->pushButtonGrowLengthRadius1, formulaBaseHeightRadius1);
    collapseFormula(
        ui->plainTextEditRadius2, ui->pushButtonGrowLengthRadius2, formulaBaseHeightRadius2);
...
void DialogEllipticalArc::pointNameChanged()
{
    ...
    if (getCurrentObjectId(ui->centerPoint_ComboBox) == m_arc.GetCenter().id()) {
        ...
        VEllipticalArc arc(
            *data->GeometricObject<VPointF>(getCurrentObjectId(ui->centerPoint_ComboBox)),
            GetRadius1().toDouble(),
            GetRadius2().toDouble(),
            GetF1().toDouble(),
            GetF2().toDouble(),
        ...
        ui->name_LineEdit->setText(
            qApp->translateVariables()->VarToUser(arc.name() + "_" + QString().setNum(m_Id)));
    }
...
//---------------------------------------------------------------------------------------------------------------------
void DialogEllipticalArc::ShowVisualization() { AddVisualization<VisToolEllipticalArc>(); }
...
//---------------------------------------------------------------------------------------------------------------------
void DialogEllipticalArc::collapseFormula(
